! function(t, e) {
    ...
    var l = "alert",
        ...
        p = function() {
            ...
            return t.close = function(t) {
                ...
                var t, i = this;
                c.default(e).removeClass("show"), c.default(e).hasClass("fade") ? (t = d.getTransitionDurationFromElement(e), c.default(e).one(d.TRANSITION_END, function(t) {
    ...
    c.default(document).on("click.bs.button.data-api", u, function(t) {
        var e, i = t.target,
            s = i;
        c.default(i).hasClass("btn") || (i = c.default(i).closest(b)[0]), !i || i.hasAttribute("disabled") || i.classList.contains("disabled") || (e = i.querySelector(w)) && (e.hasAttribute("disabled") || e.classList.contains("disabled")) ? t.preventDefault() : "INPUT" !== s.tagName && "LABEL" === i.tagName || x._jQueryInterface.call(c.default(i), "toggle", "INPUT" === s.tagName)
    ...
    var k = "carousel",
        ...
        Y = function() {
            ...
            return t.next = function() {
                ...
                c.default(this._element).off(D), c.default.removeData(this._element, C), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                ...
                var e;
                this._indicatorsElement && (e = [].slice.call(this._indicatorsElement.querySelectorAll(".active")), c.default(e).removeClass(I), (t = this._indicatorsElement.children[this._getItemIndex(t)]) && c.default(t).addClass(I))
                ...
                l && c.default(l).hasClass(I) ? this._isSliding = !1 : this._triggerSlideEvent(l, t).isDefaultPrevented() || a && l && (this._isSliding = !0, e && this.pause(), this._setActiveIndicatorElement(l), this._activeElement = l, n = c.default.Event(P, {
                    relatedTarget: l,
                    direction: t,
                    from: r,
                    to: h
                }), c.default(this._element).hasClass("slide") ? (c.default(l).addClass(s), d.reflow(l), c.default(a).addClass(i), c.default(l).addClass(i), h = d.getTransitionDurationFromElement(a), c.default(a).one(d.TRANSITION_END, function() {
                    c.default(l).removeClass(i + " " + s).addClass(I), c.default(a).removeClass(I + " " + s + " " + i), o._isSliding = !1, setTimeout(function() {
                        return c.default(o._element).trigger(n)
                    }, 0)
                }).emulateTransitionEnd(h)) : (c.default(a).removeClass(I), c.default(l).addClass(I), this._isSliding = !1, c.default(this._element).trigger(n)), e && this.cycle())
                ...
                !s || (e = c.default(s)[0]) && c.default(e).hasClass("carousel") && (i = r({}, c.default(e).data(), c.default(this).data()), (s = this.getAttribute("data-slide-to")) && (i.interval = !1), n._jQueryInterface.call(c.default(e), i), s && c.default(e).data(C).to(s), t.preventDefault())
            }, a(n, null, [{
                key: "VERSION",
                get: function() {
                    return "4.6.0"
    ...
    c.default(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", Y._dataApiClickHandler), c.default(window).on("load.bs.carousel.data-api", function() {
        for (var t = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), e = 0, i = t.length; e < i; e++) {
            var s = c.default(t[e]);
            Y._jQueryInterface.call(s, s.data())
        }
    }), c.default.fn[k] = Y._jQueryInterface, c.default.fn[k].Constructor = Y, c.default.fn[k].noConflict = function() {
            ...
            return t.toggle = function() {
                ...
                if (!this._isTransitioning && c.default(this._element).hasClass(R)) {
                    ...
                    if (c.default(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        this._element.style[e] = this._element.getBoundingClientRect()[e] + "px", d.reflow(this._element), c.default(this._element).addClass(z).removeClass(j + " " + R);
    ...
    }), c.default.fn[N] = V._jQueryInterface, c.default.fn[N].Constructor = V, c.default.fn[N].noConflict = function() {
    ...
    var q = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator,
        G = function() {
            for (var t = ["Edge", "Trident", "Firefox"], e = 0; e < t.length; e += 1)
                if (q && 0 <= navigator.userAgent.indexOf(t[e])) return 1;
            return 0
        }();
    var Q = q && window.Promise ? function(t) {
        var e = !1;
        return function() {
    ...
    function ht(t, e, i, s) {
        return Math.max(e["offset" + t], e["scroll" + t], i["client" + t], i["offset" + t], i["scroll" + t], st(10) ? parseInt(i["offset" + t]) + parseInt(s["margin" + ("Height" === t ? "Top" : "Left")]) + parseInt(s["margin" + ("Height" === t ? "Bottom" : "Right")]) : 0)
    }
    ...
    function ct(t) {
        ...
        return {
            height: ht("Height", e, i, t),
            width: ht("Width", e, i, t)
        }
    }
    var dt = function(t, e) {
    ...
    function _t(t, e, i) {
        ...
        a = mt({
            top: a.top - r.top - i,
            left: a.left - r.left - t,
            width: a.width,
            height: a.height
        });
        return a.marginTop = 0, a.marginLeft = 0, !n && o && (o = parseFloat(h.marginTop), h = parseFloat(h.marginLeft), a.top -= i - o, a.bottom -= i - o, a.left -= t - h, a.right -= t - h, a.marginTop = o, a.marginLeft = h), (n && !s ? e.contains(l) : e === l && "BODY" !== l.nodeName) && (a = function(t, e, i) {
            var s = 2 < arguments.length && void 0 !== i && i,
                i = rt(e, "top"),
                e = rt(e, "left"),
                s = s ? -1 : 1;
    ...
    function yt(t, e, i, s, n) {
        ...
        }(r, o) : (n = void 0, "scrollParent" === s ? "BODY" === (n = J(K(e))).nodeName && (n = t.ownerDocument.documentElement) : n = "window" === s ? t.ownerDocument.documentElement : s, l = _t(n, r, o), "HTML" !== n.nodeName || function t(e) {
            var i = e.nodeName;
            if ("BODY" === i || "HTML" === i) return !1;
            if ("fixed" === X(e, "position")) return !0;
            e = K(e);
            return !!e && t(e)
        }(r) ? a = l : (t = (r = ct(t.ownerDocument)).height, r = r.width, a.top += l.top - l.marginTop, a.bottom = t + l.top, a.left += l.left - l.marginLeft, a.right = r + l.left));
    ...
    function Ot(t, e, i, s) {
        i.updateBound = s, Mt(t).addEventListener("resize", i.updateBound, {
            passive: !0
        });
        t = J(t);
        return function t(e, i, s, n) {
            ...
            e.addEventListener(i, s, {
                passive: !0
            }), o || t(J(e.parentNode), i, s, n), n.push(e)
        }(t, "scroll", i.updateBound, i.scrollParents), i.scrollElement = t, i.eventsEnabled = !0, i
    }

    function Pt() {
        var t, e;
        this.state.eventsEnabled && (cancelAnimationFrame(this.scheduleUpdate), this.state = (t = this.reference, e = this.state, Mt(t).removeEventListener("resize", e.updateBound), e.scrollParents.forEach(function(t) {
    ...
    function $t(i, s) {
        Object.keys(s).forEach(function(t) {
            var e = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && It(s[t]) && (e = "px"), i.style[t] = s[t] + e
        })
    }
    var At = q && /Firefox/i.test(navigator.userAgent);

    function Yt(t, e, i) {
        var s, n = Dt(t, function(t) {
                return t.name === e
            }),
    ...
    function Rt(t, n, o, e) {
        var a = [0, 0],
            ...
            e = i.indexOf(Dt(i, function(t) {
                return -1 !== t.search(/,|\s/)
            }));
        i[e] && -1 === i[e].indexOf(",") && console.warn("Offsets separated by white space(s) are deprecated, use a comma (,) instead.");
        t = /\s*,\s*|\s+/;
        return (-1 !== e ? [i.slice(0, e).concat([i[e].split(t)[0]]), [i[e].split(t)[1]].concat(i.slice(e + 1))] : [i]).map(function(t, e) {
            ...
            return t.reduce(function(t, e) {
                ...
                return function(t, e, i, s) {
                    var n = +(o = t.match(/((?:\-|\+)?\d*\.?\d*)(.*)/))[1],
                        o = o[2];
                    if (!n) return t;
                    if (0 !== o.indexOf("%")) return "vh" !== o && "vw" !== o ? n : ("vh" === o ? Math.max(document.documentElement.clientHeight, window.innerHeight || 0) : Math.max(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * n;
                    var a = void 0;
                    switch (o) {
                        case "%p":
                            a = i;
    ...
    var e = {
            ...
            modifiers: {
                shift: {
                    ...
                    fn: function(t) {
                        var e, i, s = t.placement,
                            n = s.split("-")[0],
                            o = s.split("-")[1];
                        return o && (e = (i = t.offsets).reference, s = i.popper, n = (i = -1 !== ["bottom", "top"].indexOf(n)) ? "width" : "height", n = {
                            start: ft({}, i = i ? "left" : "top", e[i]),
                            end: ft({}, i, e[i] + e[n] - s[n])
                        }, t.offsets.popper = pt({}, s, n[o])), t
                    }
                },
                offset: {
                    order: 200,
                    ...
                    fn: function(t, e) {
                        ...
                        return "left" === o ? (n.top += s[0], n.left -= s[1]) : "right" === o ? (n.top += s[0], n.left += s[1]) : "top" === o ? (n.left += s[0], n.top -= s[1]) : "bottom" === o && (n.left += s[0], n.top += s[1]), t.popper = n, t
                    },
                    offset: 0
                },
                preventOverflow: {
                ...
                arrow: {
                    ...
                    fn: function(t, e) {
                        ...
                        var s = t.placement.split("-")[0],
                            ...
                            c = a ? "bottom" : "right",
                            s = xt(i)[r];
                        return o[c] - s < n[h] && (t.offsets.popper[h] -= n[h] - (o[c] - s)), o[h] + s > n[c] && (t.offsets.popper[h] += o[h] + s - n[c]), t.offsets.popper = mt(t.offsets.popper), a = o[h] + o[r] / 2 - s / 2, c = X(t.instance.popper), o = parseFloat(c["margin" + l]), l = parseFloat(c["border" + l + "Width"]), l = a - t.offsets.popper[h] - o - l, l = Math.max(Math.min(n[r] - s, l), 0), t.arrowElement = i, t.offsets.arrow = (ft(i = {}, h, Math.round(l)), ft(i, e, ""), i), t
                    },
                    element: "[x-arrow]"
                },
                flip: {
                    ...
                    fn: function(h, c) {
                        ...
                        return m.forEach(function(t, e) {
                            ...
                            var i = h.offsets.popper,
                                ...
                                n = Math.floor,
                                o = "left" === u && n(i.right) > n(s.left) || "right" === u && n(i.left) < n(s.right) || "top" === u && n(i.bottom) > n(s.top) || "bottom" === u && n(i.top) < n(s.bottom),
                                a = n(i.left) < n(d.left),
                                ...
                                l = n || l;
                            (o || s || l) && (h.flipped = !0, (o || s) && (u = m[e + 1]), l && (p = "end" === (l = p) ? "start" : "start" === l ? "end" : l), h.placement = u + (p ? "-" + p : ""), h.offsets.popper = pt({}, h.offsets.popper, Ct(h.instance.popper, h.offsets.reference, h.placement)), h = St(h.instance.modifiers, h, "flip"))
                        }), h
                    },
                    behavior: "flip",
                    padding: 5,
                ...
                computeStyle: {
                    ...
                    fn: function(t, e) {
                        var i = e.x,
                            s = e.y,
                            n = t.offsets.popper;
                        void 0 !== (p = Dt(t.instance.modifiers, function(t) {
                        ...
                        var o, a, r, l, h = void 0 !== p ? p : e.gpuAcceleration,
                            c = nt(t.instance.popper),
                            d = gt(c),
                            u = {
                                position: n.position
                            },
                            f = (o = t, f = window.devicePixelRatio < 2 || !At, m = (l = o.offsets).popper, a = l.reference, r = Math.round, p = Math.floor, e = function(t) {
                                return t
                            }, n = r(a.width), l = r(m.width), a = -1 !== ["left", "right"].indexOf(o.placement), o = -1 !== o.placement.indexOf("-"), p = f ? a || o || n % 2 == l % 2 ? r : p : e, e = f ? r : e, {
                                left: p(n % 2 == 1 && l % 2 == 1 && !o && f ? m.left - 1 : m.left),
                                top: e(m.top),
                                bottom: e(m.bottom),
                                right: p(m.right)
                            }),
                        ...
                        return h && m ? (u[m] = "translate3d(" + i + "px, " + s + "px, 0)", u[e] = 0, u[p] = 0, u.willChange = "transform") : (h = "bottom" == e ? -1 : 1, m = "right" == p ? -1 : 1, u[e] = s * h, u[p] = i * m, u.willChange = e + ", " + p), p = {
                            "x-placement": t.placement
                        }, t.attributes = pt({}, p, t.attributes), t.styles = pt({}, u, t.styles), t.arrowStyles = pt({}, t.offsets.arrow, t.arrowStyles), t
                    },
                    gpuAcceleration: !0,
                    x: "bottom",
                    y: "right"
                ...
                applyStyle: {
                    ...
                    fn: function(t) {
                        var e, i;
                        return $t(t.instance.popper, t.styles), e = t.instance.popper, i = t.attributes, Object.keys(i).forEach(function(t) {
                            !1 !== i[t] ? e.setAttribute(t, i[t]) : e.removeAttribute(t)
                        }), t.arrowElement && Object.keys(t.arrowStyles).length && $t(t.arrowElement, t.arrowStyles), t
                    },
                    onLoad: function(t, e, i, s, n) {
                        return n = bt(n, e, t, i.positionFixed), t = wt(i.placement, n, e, t, i.modifiers.flip.boundariesElement, i.modifiers.flip.padding), e.setAttribute("x-placement", t), $t(e, {
            ...
            value: function() {
                return function() {
                    ...
                    this.state.isDestroyed || ((t = {
                        ...
                        flipped: !1,
                        offsets: {}
                    }).offsets.reference = bt(this.state, this.popper, this.reference, this.options.positionFixed), t.placement = wt(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), t.originalPlacement = t.placement, t.positionFixed = this.options.positionFixed, t.offsets.popper = Ct(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", t = St(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, this.options.onCreate(t)))
                }.call(this)
            }
        }, {
            key: "destroy",
    ...
    function zt(t, e) {
        ...
        dt(this, zt), this.scheduleUpdate = function() {
            return requestAnimationFrame(i.update)
        }, this.update = Q(this.update.bind(this)), this.options = pt({}, zt.Defaults, s), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        }, this.reference = t && t.jquery ? t[0] : t, this.popper = e && e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(pt({}, zt.Defaults.modifiers, s.modifiers)).forEach(function(t) {
    ...
    var Bt = "dropdown",
        ...
        ne = function() {
            ...
            return t.toggle = function() {
                ...
                if (void 0 === t && (t = !1), !(this._element.disabled || c.default(this._element).hasClass(Xt) || c.default(this._menu).hasClass(Kt))) {
                    ...
                    if (c.default(s).trigger(i), !i.isDefaultPrevented()) {
                        if (!this._inNavbar && t) {
                            ...
                            t = this._element;
                            "parent" === this._config.reference ? t = s : d.isElement(this._config.reference) && (t = this._config.reference, void 0 !== this._config.reference.jquery && (t = this._config.reference[0])), "scrollParent" !== this._config.boundary && c.default(s).addClass("position-static"), this._popper = new jt(t, this._menu, this._getPopperConfig())
                        }
                ...
                var t, e, i;
                this._element.disabled || c.default(this._element).hasClass(Xt) || !c.default(this._menu).hasClass(Kt) || (t = {
                    relatedTarget: this._element
                }, e = c.default.Event(Qt, t), i = h._getParentFromElement(this._element), c.default(i).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), c.default(this._menu).toggleClass(Kt), c.default(i).toggleClass(Kt).trigger(c.default.Event(Zt, t))))
            }, t.dispose = function() {
                ...
                var t = c.default(this._element.parentNode),
                    e = "bottom-start";
                return t.hasClass("dropup") ? e = c.default(this._menu).hasClass(Jt) ? "top-end" : "top-start" : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : c.default(this._menu).hasClass(Jt) && (e = "bottom-end"), e
                ...
                if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || c.default(t.target).closest(ee).length)) : Gt.test(t.which)) && !this.disabled && !c.default(this).hasClass(Xt)) {
                    var e = h._getParentFromElement(this),
                        i = c.default(e).hasClass(Kt);
                    if (i || 27 !== t.which) {
                        if (t.preventDefault(), t.stopPropagation(), !i || 27 === t.which || 32 === t.which) return 27 === t.which && c.default(e.querySelector(te)).trigger("focus"), void c.default(this).trigger("click");
    ...
    c.default(document).on(e, te, ne._dataApiKeydownHandler).on(e, ee, ne._dataApiKeydownHandler).on(_ + " keyup.bs.dropdown.data-api", ne._clearMenus).on(_, te, function(t) {
        t.preventDefault(), t.stopPropagation(), ne._jQueryInterface.call(c.default(this), "toggle")
    }).on(_, ".dropdown form", function(t) {
        t.stopPropagation()
    }), c.default.fn[Bt] = ne._jQueryInterface, c.default.fn[Bt].Constructor = ne, c.default.fn[Bt].noConflict = function() {
    ...
    var oe = "modal",
        ...
        Ce = function() {
            ...
            return t.toggle = function(t) {
                ...
                var e, i = this;
                this._isShown || this._isTransitioning || (c.default(this._element).hasClass(ye) && (this._isTransitioning = !0), e = c.default.Event(ue, {
                    relatedTarget: t
                }), c.default(this._element).trigger(e), this._isShown || e.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), c.default(this._element).on(me, '[data-dismiss="modal"]', function(t) {
                    return i.hide(t)
                ...
                c.default(this._element).trigger(s), s.isDefaultPrevented() || ((t = this._element.scrollHeight > document.documentElement.clientHeight) || (this._element.style.overflowY = "hidden"), this._element.classList.add(be), e = d.getTransitionDurationFromElement(this._dialog), c.default(this._element).off(d.TRANSITION_END), c.default(this._element).one(d.TRANSITION_END, function() {
                    i._element.classList.remove(be), t || c.default(i._element).one(d.TRANSITION_END, function() {
                ...
                this._isShown && this._config.backdrop ? (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", s && this._backdrop.classList.add(s), c.default(this._backdrop).appendTo(document.body), c.default(this._element).on(me, function(t) {
                ...
                }), s && d.reflow(this._backdrop), c.default(this._backdrop).addClass(we), t && (s ? (e = d.getTransitionDurationFromElement(this._backdrop), c.default(this._backdrop).one(d.TRANSITION_END, t).emulateTransitionEnd(e)) : t())) : !this._isShown && this._backdrop ? (c.default(this._backdrop).removeClass(we), s = function() {
                    i._removeBackdrop(), t && t()
                }, c.default(this._element).hasClass(ye) ? (e = d.getTransitionDurationFromElement(this._backdrop), c.default(this._backdrop).one(d.TRANSITION_END, s).emulateTransitionEnd(e)) : s()) : t && t()
                ...
                var t, e, n = this;
                this._isBodyOverflowing && (t = [].slice.call(document.querySelectorAll(xe)), e = [].slice.call(document.querySelectorAll(ke)), c.default(t).each(function(t, e) {
                ...
                }), t = document.body.style.paddingRight, e = c.default(document.body).css("padding-right"), c.default(document.body).data("padding-right", t).css("padding-right", parseFloat(e) + this._scrollbarWidth + "px")), c.default(document.body).addClass(ve)
    ...
    c.default(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(t) {
        ...
        var n = c.default(e).one(ue, function(t) {
            t.isDefaultPrevented() || n.one(de, function() {
                c.default(i).is(":visible") && i.focus()
            })
        });
        Ce._jQueryInterface.call(c.default(e), s, this)
    }), c.default.fn[oe] = Ce._jQueryInterface, c.default.fn[oe].Constructor = Ce, c.default.fn[oe].noConflict = function() {
    ...
    function Ee(t, o, e) {
        ...
        for (var t = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(o), r = [].slice.call(t.body.querySelectorAll("*")), i = function(t, e) {
                var i = r[t],
    ...
    var Me = "tooltip",
        ...
        Ue = function() {
            ...
            return t.enable = function() {
                ...
                "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Ee(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? c.default(e).parent().is(t) || t.empty().append(e) : t.text(c.default(e).text())
            }, t.getTitle = function() {
                ...
                this.config.trigger.split(" ").forEach(function(t) {
                    ...
                    "click" === t ? c.default(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(t) {
                        return i.toggle(t)
                    }) : "manual" !== t && (e = t === ze ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN, t = t === ze ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT, c.default(i.element).on(e, i.config.selector, function(t) {
                        return i._enter(t)
                    ...
                    i.element && i.hide()
                }, c.default(this.element).closest(".modal").on("hide.bs.modal", this._hideModalHandler), this.config.selector ? this.config = r({}, this.config, {
                    trigger: "manual",
                    selector: ""
                }) : this._fixTitle()
                ...
                return Object.keys(e).forEach(function(t) {
                    ...
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), d.typeCheckConfig(Me, t, this.constructor.DefaultType), t.sanitize && (t.template = Ee(t.template, t.whiteList, t.sanitizeFn)), t
    ...
    c.default.fn[Me] = Ue._jQueryInterface, c.default.fn[Me].Constructor = Ue, c.default.fn[Me].noConflict = function() {
    ...
    c.default.fn[Ve] = ei._jQueryInterface, c.default.fn[Ve].Constructor = ei, c.default.fn[Ve].noConflict = function() {
    ...
    var ii = "scrollspy",
        ...
        ui = "position",
            ...
            function i(t, e) {
                var i = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + ci + "," + this._config.target + " " + di + "," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, c.default(this._scrollElement).on("scroll.bs.scrollspy", function(t) {
                    return i._process(t)
            ...
            return t.refresh = function() {
                ...
                c.default.removeData(this._element, si), c.default(this._scrollElement).off(ni), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, t._getConfig = function(t) {
                var e;
                return "string" != typeof(t = r({}, ai, "object" == typeof t && t ? t : {})).target && d.isElement(t.target) && ((e = c.default(t.target).attr("id")) || (e = d.getUID(ii), c.default(t.target).attr("id", e)), t.target = "#" + e), d.typeCheckConfig(ii, t, ri), t
                ...
                t.hasClass("dropdown-item") ? (t.closest(".dropdown").find(".dropdown-toggle").addClass(li), t.addClass(li)) : (t.addClass(li), t.parents(hi).prev(ci + ", " + di).addClass(li), t.parents(hi).prev(".nav-item").children(ci).addClass(li)), c.default(this._scrollElement).trigger("activate.bs.scrollspy", {
                    relatedTarget: e
                })
            }, t._clear = function() {
    ...
    }), c.default.fn[ii] = fi._jQueryInterface, c.default.fn[ii].Constructor = fi, c.default.fn[ii].noConflict = function() {
        ...
        yi = function() {
            ...
            return t.show = function() {
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && c.default(this._element).hasClass(gi) || c.default(this._element).hasClass("disabled") || (o = c.default(this._element).closest(".nav, .list-group")[0], e = d.getSelectorFromElement(this._element), o && (n = "UL" === o.nodeName || "OL" === o.nodeName ? vi : _i, i = (i = c.default.makeArray(c.default(o).find(n)))[i.length - 1]), s = c.default.Event("hide.bs.tab", {
                    relatedTarget: this._element
                }), n = c.default.Event("show.bs.tab", {
                    relatedTarget: i
                }), i && c.default(i).trigger(s), c.default(this._element).trigger(n), n.isDefaultPrevented() || s.isDefaultPrevented() || (e && (t = document.querySelector(e)), this._activate(this._element, o), o = function() {
    ...
    }), c.default.fn.tab = yi._jQueryInterface, c.default.fn.tab.Constructor = yi, c.default.fn.tab.noConflict = function() {
    ...
    var wi = "toast",
        ...
        Ei = function() {
            ...
            return t.show = function() {
                ...
                c.default(this._element).trigger(i), i.isDefaultPrevented() || (this._clearTimeout(), this._config.animation && this._element.classList.add("fade"), t = function() {
                    e._element.classList.remove(Di), e._element.classList.add(Ci), c.default(e._element).trigger("shown.bs.toast"), e._config.autohide && (e._timeout = setTimeout(function() {
                        e.hide()
                    }, e._config.delay))
                }, this._element.classList.remove("hide"), d.reflow(this._element), this._element.classList.add(Di), this._config.animation ? (i = d.getTransitionDurationFromElement(this._element), c.default(this._element).one(d.TRANSITION_END, t).emulateTransitionEnd(i)) : t())
            }, t.hide = function() {
                var t;
                ...
                this._clearTimeout(), this._element.classList.contains(Ci) && this._element.classList.remove(Ci), c.default(this._element).off(ki), c.default.removeData(this._element, bi), this._element = null, this._config = null
            }, t._getConfig = function(t) {
    ...
    c.default.fn[wi] = Ei._jQueryInterface, c.default.fn[wi].Constructor = Ei, c.default.fn[wi].noConflict = function() {
        return c.default.fn[wi] = xi, Ei._jQueryInterface
    }, t.Alert = p, t.Button = x, t.Carousel = Y, t.Collapse = V, t.Dropdown = ne, t.Modal = Ce, t.Popover = ei, t.Scrollspy = fi, t.Tab = yi, t.Toast = Ei, t.Tooltip = Ue, t.Util = d, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}),
function(a, r, l, s) {
    function h(t, e) {
        ...
        for (var n = 0, t = ["ms", "moz", "webkit", "o"], e = 0; e < t.length && !r.requestAnimationFrame; ++e) r.requestAnimationFrame = r[t[e] + "RequestAnimationFrame"], r.cancelAnimationFrame = r[t[e] + "CancelAnimationFrame"] || r[t[e] + "CancelRequestAnimationFrame"];
        ...
        setup: function() {
            ...
            this.isReady || (e = this, t = a(l), s = a(r), i = function() {
                ...
                n(), h.requestRender()
            }), i(), n(), this.isReady = !0, o = -1, function t() {
    ...
    a.fn.parallax = function(i) {
        return this.each(function() {
            var t = a(this),
                e = "object" == typeof i && i;
            this == r || this == l || t.is("body") ? h.configure(e) : t.data("px.parallax") ? "object" == typeof i && a.extend(t.data("px.parallax"), e) : (e = a.extend({}, t.data(), e), t.data("px.parallax", new h(this, e))), "string" == typeof i && ("destroy" == i ? h.destroy(this) : h[i]())
        })
...
function(t) {
    ...
    t.prototype = {
        ...
        init: function() {
            ...
            p.isLowIE = p.isIE8 = document.all && !document.addEventListener, p.isAndroid = /android/gi.test(t), p.isIOS = /iphone|ipad|ipod/gi.test(t), p.supportsTransition = function() {
                ...
                return !1
            }(), p.probablyMobile = p.isAndroid || p.isIOS || /(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IEMobile/i.test(navigator.userAgent), m = h(document), p.popupsCache = {}
        },
        open: function(t) {
            if (!1 === t.isObj) {
            ...
            if (!p.isOpen) {
                p.types = [], g = "", t.mainEl && t.mainEl.length ? p.ev = t.mainEl.eq(0) : p.ev = m, t.key ? (p.popupsCache[t.key] || (p.popupsCache[t.key] = {}), p.currTemplate = p.popupsCache[t.key]) : p.currTemplate = {}, p.st = h.extend(!0, {}, h.magnificPopup.defaults, t), p.fixedContentPos = "auto" === p.st.fixedContentPos ? !p.probablyMobile : p.st.fixedContentPos, p.st.modal && (p.st.closeOnContentClick = !1, p.st.closeOnBgClick = !1, p.st.showCloseBtn = !1, p.st.enableEscapeKey = !1), p.bgOverlay || (p.bgOverlay = d("bg").on("click" + w, function() {
                    p.close()
                }), p.wrap = d("wrap").attr("tabindex", -1).on("click" + w, function(t) {
                ...
                u("BeforeOpen"), p.st.showCloseBtn && (p.st.closeBtnInside ? (c(v, function(t, e, i, s) {
                    i.close_replaceWith = f(s.type)
                }), g += " mfp-close-btn-in") : p.wrap.append(f())), p.st.alignTop && (g += " mfp-align-top"), p.fixedContentPos ? p.wrap.css({
                    ...
                    height: m.height(),
                    position: "absolute"
                }), p.st.enableEscapeKey && m.on("keyup" + w, function(t) {
                ...
                var a = p.wH = x.height(),
                    r = {};
                p.fixedContentPos && (!p._hasScrollBar(a) || (l = p._getScrollbarSize()) && (r.marginRight = l)), p.fixedContentPos && (p.isIE7 ? h("body, html").css("overflow", "hidden") : r.overflow = "hidden");
                var l = p.st.mainClass;
                return p.isIE7 && (l += " mfp-ie7"), l && p._addClassToMFP(l), p.updateItemHTML(), u("BuildControls"), h("html").css(r), p.bgOverlay.add(p.wrap).prependTo(p.st.prependTo || h(document.body)), p._lastFocusedEl = document.activeElement, setTimeout(function() {
                    p.content ? (p._addClassToMFP(b), p._setFocus()) : p.bgOverlay.addClass(b), m.on("focusin" + w, p._onFocusIn)
                }, 16), p.isOpen = !0, p.updateSize(a), u(y), t
            }
            p.updateItemHTML()
        },
        close: function() {
            p.isOpen && (u(_), p.isOpen = !1, p.st.removalDelay && !p.isLowIE && p.supportsTransition ? (p._addClassToMFP(i), setTimeout(function() {
                p._close()
        ...
        _close: function() {
            u(l);
            var t = i + " " + b + " ";
            p.bgOverlay.detach(), p.wrap.detach(), p.container.empty(), p.st.mainClass && (t += p.st.mainClass + " "), p._removeClassFromMFP(t), p.fixedContentPos && (t = {
                marginRight: ""
            }, p.isIE7 ? h("body, html").css("overflow", "") : t.overflow = "", h("html").css(t)), m.off("keyup.mfp focusin" + w), p.ev.off(w), p.wrap.attr("class", "mfp-wrap").removeAttr("style"), p.bgOverlay.attr("class", "mfp-bg"), p.container.attr("class", "mfp-container"), !p.st.showCloseBtn || p.st.closeBtnInside && !0 !== p.currTemplate[p.currItem.type] || p.currTemplate.closeBtn && p.currTemplate.closeBtn.detach(), p.st.autoFocusLast && p._lastFocusedEl && h(p._lastFocusedEl).focus(), p.currItem = null, p.content = null, p.currTemplate = null, p.prevHeight = 0, u("AfterClose")
        },
        updateSize: function(t) {
            var e;
            p.isIOS ? (e = document.documentElement.clientWidth / window.innerWidth, e = window.innerHeight * e, p.wrap.css("height", e), p.wH = e) : p.wH = t || x.height(), p.fixedContentPos || p.wrap.css("height", p.wH), u("Resize")
        },
        updateItemHTML: function() {
            var t = p.items[p.index];
            p.contentContainer.detach(), p.content && p.content.detach(), t.parsed || (t = p.parseEl(p.index));
            var e = t.type;
            u("BeforeChange", [p.currItem ? p.currItem.type : "", e]), p.currItem = t, p.currTemplate[e] || (i = !!p.st[e] && p.st[e].markup, u("FirstMarkupParse", i), p.currTemplate[e] = !i || h(i)), n && n !== t.type && p.container.removeClass("mfp-" + n + "-holder");
        ...
        appendContent: function(t, e) {
            (p.content = t) ? p.st.showCloseBtn && p.st.closeBtnInside && !0 === p.currTemplate[e] ? p.content.find(".mfp-close").length || p.content.append(f()) : p.content = t: p.content = "", u("BeforeAppend"), p.container.addClass("mfp-" + e + "-holder"), p.contentContainer.append(p.content)
        },
        parseEl: function(t) {
            var e, i = p.items[t];
            if ((i = i.tagName ? {
        ...
        updateStatus: function(t, e) {
            var i;
            p.preloader && (s !== t && p.container.removeClass("mfp-s-" + s), e || "loading" !== t || (e = p.st.tLoading), u("UpdateStatus", i = {
                status: t,
                text: e
            }), t = i.status, e = i.text, p.preloader.html(e), p.preloader.find("a").on("click", function(t) {
                t.stopImmediatePropagation()
            }), p.container.addClass("mfp-s-" + t), s = t)
        },
        ...
        _parseMarkup: function(n, t, e) {
            var o;
            e.data && (t = h.extend(e.data, t)), u(v, [n, t, e]), h.each(t, function(t, e) {
                return void 0 === e || !1 === e || void(1 < (o = t.split("_")).length ? 0 < (i = n.find(w + "-" + o[0])).length && ("replaceWith" === (s = o[1]) ? i[0] !== e[0] && i.replaceWith(e) : "img" === s ? i.is("img") ? i.attr("src", e) : i.replaceWith(h("<img>").attr("src", e).attr("class", i.attr("class"))) : i.attr(o[1], e)) : n.find(w + "-" + t).html(e));
                var i, s
            })
        },
        _getScrollbarSize: function() {
            var t;
            return void 0 === p.scrollbarSize && ((t = document.createElement("div")).style.cssText = "width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;", document.body.appendChild(t), p.scrollbarSize = t.offsetWidth - t.clientWidth, document.body.removeChild(t)), p.scrollbarSize
        }
    }, h.magnificPopup = {
        instance: null,
        proto: t.prototype,
        ...
        o();
        var e, i, s, n = h(this);
        return "string" == typeof t ? "open" === t ? (e = r ? n.data("magnificPopup") : n[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, s = e.items ? e.items[i] : (s = n, e.delegate && (s = s.find(e.delegate)), s.eq(i)), p._openClick({
            mfpEl: s
        }, n, e)) : p.isOpen && p[t].apply(p, Array.prototype.slice.call(arguments, 1)) : (t = h.extend(!0, {}, t), r ? n.data("magnificPopup", t) : n[0].magnificPopup = t, p.addGroup(n, t)), n
    };
        ...
        proto: {
            ...
            getInline: function(t, e) {
                if (k(), t.src) {
                    var i, s = p.st.inline,
                        n = h(t.src);
                    return n.length ? ((i = n[0].parentNode) && i.tagName && (D || (C = s.hiddenClass, D = d(C), C = "mfp-" + C), S = n.after(D).detach().removeClass(C)), p.updateStatus("ready")) : (p.updateStatus("error", s.tNotFound), n = h("<div>")), t.inlineElement = n
                }
            ...
            getAjax: function(s) {
                ...
                var t = h.extend({
                    ...
                    success: function(t, e, i) {
                        ...
                        u("ParseAjax", i), p.appendContent(h(i.data), P), s.finished = !0, E(), p._setFocus(), setTimeout(function() {
                            p.wrap.addClass(b)
    ...
    h.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var t = p.st.image,
                    e = ".image";
                p.types.push("image"), c(y + e, function() {
                ...
                }), c("Resize" + e, p.resizeImage), p.isLowIE && c("AfterChange", p.resizeImage)
            },
            ...
            getImage: function(t, e) {
                var i, s = 0,
                    n = function() {
                        t && (t.img[0].complete ? (t.img.off(".mfploader"), t === p.currItem && (p._onImageHasSize(t), p.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, u("ImageLoadComplete")) : ++s < 200 ? setTimeout(n, 100) : o())
                    },
                    o = function() {
                    ...
                    a = p.st.image,
                    r = e.find(".mfp-img");
                return r.length && ((i = document.createElement("img")).className = "mfp-img", t.el && t.el.find("img").length && (i.alt = t.el.find("img").attr("alt")), t.img = h(i).on("load.mfploader", n).on("error.mfploader", o), i.src = t.src, r.is("img") && (t.img = t.img.clone()), 0 < (i = t.img[0]).naturalWidth ? t.hasSize = !0 : i.width || (t.hasSize = !1)), p._parseMarkup(e, {
                    title: function(t) {
                ...
                }, t), p.resizeImage(), t.hasSize ? (I && clearInterval(I), t.loadError ? (e.addClass("mfp-loading"), p.updateStatus("error", a.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), p.updateStatus("ready"))) : (p.updateStatus("loading"), t.loading = !0, t.hasSize || (t.imgHidden = !0, e.addClass("mfp-loading"), p.findImageSize(t))), e
            }
        }
    });
    var $;
    h.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                var t, e, i, s, n, o, a = p.st.zoom,
                    r = ".zoom";
                a.enabled && p.supportsTransition && (e = a.duration, i = function(t) {
                    ...
                    p._allowZoom() && (clearTimeout(n), p.content.css("visibility", "hidden"), (t = p._getItemToZoom()) ? ((o = i(t)).css(p._getOffset()), p.wrap.append(o), n = setTimeout(function() {
                        o.css(p._getOffset(!0)), n = setTimeout(function() {
            ...
            _getOffset: function(t) {
                ...
                return void 0 === $ && ($ = void 0 !== document.createElement("p").style.MozTransform), $ ? s["-moz-transform"] = s.transform = "translate(" + i.left + "px," + i.top + "px)" : (s.left = i.left, s.top = i.top), s
            }
        }
    });
    ...
    h.magnificPopup.registerModule(Y, {
        ...
        proto: {
            initIframe: function() {
                p.types.push(Y), c("BeforeChange", function(t, e, i) {
                    e !== i && (e === Y ? A() : i === Y && A(!0))
                }), c(l + "." + Y, function() {
                    A()
                })
    ...
    h.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                g += " mfp-gallery", c(y + t, function() {
                    o.navigateByImgClick && p.wrap.on("click" + t, ".mfp-img", function() {
                    ...
                    var t, e;
                    1 < p.items.length && o.arrows && !p.arrowLeft && (e = o.arrowMarkup, t = p.arrowLeft = h(e.replace(/%title%/gi, o.tPrev).replace(/%dir%/gi, "left")).addClass(a), e = p.arrowRight = h(e.replace(/%title%/gi, o.tNext).replace(/%dir%/gi, "right")).addClass(a), t.click(function() {
                        p.prev()
                    }), e.click(function() {
                        p.next()
            ...
            _preloadItem: function(t) {
                var e;
                t = N(t), p.items[t].preloaded || ((e = p.items[t]).parsed || (e = p.parseEl(t)), u("LazyLoad", e), "image" === e.type && (e.img = h('<img class="mfp-img" />').on("load.mfploader", function() {
                    e.hasSize = !0
    ...
    h.magnificPopup.registerModule(L, {
        ...
        proto: {
            initRetina: function() {
                var i, s;
                1 < window.devicePixelRatio && (i = p.st.retina, s = i.ratio, 1 < (s = isNaN(s) ? s() : s) && (c("ImageHasSize." + L, function(t, e) {
                    e.img.css({
...
function() {
    ...
    }, t = o, i = this.WeakMap || this.MozWeakMap || (r.prototype.get = function(t) {
    ...
    }, r), s = this.MutationObserver || this.WebkitMutationObserver || this.MozMutationObserver || (h.notSupported = !0, h.prototype.observe = function() {}, h), l = this.getComputedStyle || function(i, t) {
    ...
    function(e) {
        ...
        function n(t, e, i) {
            ...
            i !== h && "" !== i && ((i = i.split(s.input_values_separator || e.input_values_separator || ";"))[0] && i[0] == +i[0] && (i[0] = +i[0]), i[1] && i[1] == +i[1] && (i[1] = +i[1]), e && e.values && e.values.length ? (t.from = i[0] && e.values.indexOf(i[0]), t.to = i[1] && e.values.indexOf(i[1])) : (t.from = i[0] && +i[0], t.to = i[1] && +i[1])), a.extend(t, e), a.extend(t, s), this.options = t, this.update_check = {}, this.validate(), this.result = {
        ...
        n.prototype = {
                ...
                pointerUp: function(t) {
                    this.current_plugin === this.plugin_count && this.is_active && (this.is_active = !1, this.$cache.cont.find(".state_hover").removeClass("state_hover"), this.force_redraw = !0, s && a("*").prop("unselectable", !1), this.updateScene(), this.restoreOriginalMinInterval(), (a.contains(this.$cache.cont[0], t.target) || this.dragging) && this.callOnFinish(), this.dragging = !1)
                },
                pointerDown: function(t, e) {
                    e.preventDefault();
                    var i = e.pageX || e.originalEvent.touches && e.originalEvent.touches[0].pageX;
                    2 !== e.button && ("both" === t && this.setTempMinInterval(), t = t || (this.target || "from"), this.current_plugin = this.plugin_count, this.target = t, this.is_active = !0, this.dragging = !0, this.coords.x_gap = this.$cache.rs.offset().left, this.coords.x_pointer = i - this.coords.x_gap, this.calcPointerPercent(), this.changeLevel(t), s && a("*").prop("unselectable", !0), this.$cache.line.trigger("focus"), this.updateScene())
                },
                        ...
                        switch ("both" === this.target && (this.coords.p_gap = 0, e = this.getHandleX()), "click" === this.target && (this.coords.p_gap = this.coords.p_handle / 2, e = this.getHandleX(), this.options.drag_interval ? this.target = "both_one" : this.target = this.chooseHandle(e)), this.target) {
                            ...
                            case "both_one":
                                ...
                                var o = this.convertToRealPercent(e),
                                    ...
                                    i = o - n,
                                    n = o + n;
                                i < 0 && (n = (i = 0) + s), 100 < n && (i = (n = 100) - s), this.coords.p_from_real = this.calcWithStep(i), this.coords.p_from_real = this.checkDiapason(this.coords.p_from_real, this.options.from_min, this.options.from_max), this.coords.p_from_fake = this.convertToFakePercent(this.coords.p_from_real), this.coords.p_to_real = this.calcWithStep(n), this.coords.p_to_real = this.checkDiapason(this.coords.p_to_real, this.options.to_min, this.options.to_max), this.coords.p_to_fake = this.convertToFakePercent(this.coords.p_to_real)
                        }
                ...
                drawLabels: function() {
                    var t, e, i, s, n, o;
                    this.options && (t = this.options.values.length, e = this.options.p_values, this.options.hide_from_to || ("single" === this.options.type ? (s = t ? this.decorate(e[this.result.from]) : (o = this._prettify(this.result.from), this.decorate(o, this.result.from)), this.$cache.single.html(s), this.calcLabels(), this.labels.p_single_left < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = "hidden" : this.$cache.min[0].style.visibility = "visible", this.labels.p_single_left + this.labels.p_single_fake > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = "hidden" : this.$cache.max[0].style.visibility = "visible") : (o = t ? (this.options.decorate_both ? (s = this.decorate(e[this.result.from]), s += this.options.values_separator, s += this.decorate(e[this.result.to])) : s = this.decorate(e[this.result.from] + this.options.values_separator + e[this.result.to]), n = this.decorate(e[this.result.from]), this.decorate(e[this.result.to])) : (o = this._prettify(this.result.from), i = this._prettify(this.result.to), this.options.decorate_both ? (s = this.decorate(o, this.result.from), s += this.options.values_separator, s += this.decorate(i, this.result.to)) : s = this.decorate(o + this.options.values_separator + i, this.result.to), n = this.decorate(o, this.result.from), this.decorate(i, this.result.to)), this.$cache.single.html(s), this.$cache.from.html(n), this.$cache.to.html(o), this.calcLabels(), i = Math.min(this.labels.p_single_left, this.labels.p_from_left), s = this.labels.p_single_left + this.labels.p_single_fake, n = this.labels.p_to_left + this.labels.p_to_fake, o = Math.max(s, n), this.labels.p_from_left + this.labels.p_from_fake >= this.labels.p_to_left ? (this.$cache.from[0].style.visibility = "hidden", this.$cache.to[0].style.visibility = "hidden", this.$cache.single[0].style.visibility = "visible", o = this.result.from === this.result.to ? ("from" === this.target ? this.$cache.from[0].style.visibility = "visible" : "to" === this.target ? this.$cache.to[0].style.visibility = "visible" : this.target || (this.$cache.from[0].style.visibility = "visible"), this.$cache.single[0].style.visibility = "hidden", n) : (this.$cache.from[0].style.visibility = "hidden", this.$cache.to[0].style.visibility = "hidden", this.$cache.single[0].style.visibility = "visible", Math.max(s, n))) : (this.$cache.from[0].style.visibility = "visible", this.$cache.to[0].style.visibility = "visible", this.$cache.single[0].style.visibility = "hidden"), i < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = "hidden" : this.$cache.min[0].style.visibility = "visible", o > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = "hidden" : this.$cache.max[0].style.visibility = "visible")))
                },
                drawShadow: function() {
                ...
                appendGrid: function() {
                    if (this.options.grid) {
                        var t, e, i, s, n, o = this.options,
                            ...
                            c = 4,
                            d = "";
                        for (this.calcGridMargin(), l = o.grid_snap ? 50 < a ? (r = 50 / o.step, this.toFixed(o.step / .5)) : (r = a / o.step, this.toFixed(o.step / (a / 100))) : this.toFixed(100 / r), 4 < r && (c = 3), 7 < r && (c = 2), 14 < r && (c = 1), 28 < r && (c = 0), t = 0; t < r + 1; t++) {
    ...
    function(t) {
        ...
        function i(t, e, i) {
            ...
            i = a.extend(!0, {}, e, i), this.settings = a.extend(!0, {}, s, i), this._defaults = s, "-" === this.settings.content.target && (this.settings.content.target = this.settings.url_target), this.animations = {
                start: "webkitAnimationStart oanimationstart MSAnimationStart animationstart",
                end: "webkitAnimationEnd oanimationend MSAnimationEnd animationend"
            }, "number" == typeof this.settings.offset && (this.settings.offset = {
                x: this.settings.offset,
                y: this.settings.offset
            }), !this.settings.allow_duplicates && (this.settings.allow_duplicates || (n = this, o = !1, a('[data-notify="container"]').each(function(t, e) {
                var i = a(e),
                    s = i.find('[data-notify="title"]').html().trim(),
                    e = i.find('[data-notify="message"]').html().trim(),
                    s = s === a("<div>" + n.settings.content.title + "</div>").html().trim(),
                    e = e === a("<div>" + n.settings.content.message + "</div>").html().trim(),
        ...
        String.format = function() {
            ...
            init: function() {
                ...
                this.buildNotify(), this.settings.content.icon && this.setIcon(), "#" != this.settings.content.url && this.styleURL(), this.styleDismiss(), this.placement(), this.bind(), this.notify = {
                    ...
                    update: function(t, e) {
                        var i, s = {};
                        for (i in "string" == typeof t ? s[t] = e : s = t, s) switch (i) {
                            case "type":
                                this.$ele.removeClass("alert-" + o.settings.type), this.$ele.find('[data-notify="progressbar"] > .progress-bar').removeClass("progress-bar-" + o.settings.type), o.settings.type = s[i], this.$ele.addClass("alert-" + s[i]).find('[data-notify="progressbar"] > .progress-bar').addClass("progress-bar-" + s[i]);
                                break;
                            case "icon":
                                var n = this.$ele.find('[data-notify="icon"]');
                                "class" === o.settings.icon_type.toLowerCase() ? n.removeClass(o.settings.content.icon).addClass(s[i]) : (n.is("img") || n.find("img"), n.attr("src", s[i])), o.settings.content.icon = s[t];
                                break;
                            case "progress":
                                n = o.settings.delay - o.settings.delay * (s[i] / 100);
                                this.$ele.data("notify-delay", n), this.$ele.find('[data-notify="progressbar"] > div').attr("aria-valuenow", s[i]).css("width", s[i] + "%");
                                break;
                            case "url":
            ...
            buildNotify: function() {
                ...
                this.$ele = a(String.format(this.settings.template, this.settings.type, t.title, t.message, t.url, t.target)), this.$ele.attr("data-notify-position", this.settings.placement.from + "-" + this.settings.placement.align), this.settings.allow_dismiss || this.$ele.find('[data-notify="dismiss"]').css("display", "none"), (this.settings.delay <= 0 && !this.settings.showProgressbar || !this.settings.showProgressbar) && this.$ele.find('[data-notify="progressbar"]').remove()
            },
            setIcon: function() {
            ...
            placement: function() {
                ...
                this.$ele.css(e).addClass(this.settings.animate.enter), a.each(Array("webkit-", "moz-", "o-", "ms-", ""), function(t, e) {
                    i.$ele[0].style[e + "AnimationIterationCount"] = 1
                }), a(this.settings.element).append(this.$ele), !0 === this.settings.newest_on_top && (t = parseInt(t) + parseInt(this.settings.spacing) + this.$ele.outerHeight(), this.reposition(t)), a.isFunction(i.settings.onShow) && i.settings.onShow.call(this.$ele), this.$ele.one(this.animations.start, function() {
                    s = !0
            ...
            bind: function() {
                ...
                this.$ele.find('[data-notify="dismiss"]').on("click", function() {
                    s.close()
                }), a.isFunction(s.settings.onClick) && this.$ele.on("click", function(t) {
                ...
                }), this.$ele.data("data-hover", "false"), 0 < this.settings.delay && (s.$ele.data("notify-delay", s.settings.delay), i = setInterval(function() {
                    var t, e = parseInt(s.$ele.data("notify-delay")) - s.settings.timer;
                    ("false" === s.$ele.data("data-hover") && "pause" === s.settings.mouse_over || "pause" != s.settings.mouse_over) && (t = (s.settings.delay - e) / s.settings.delay * 100, s.$ele.data("notify-delay", e), s.$ele.find('[data-notify="progressbar"] > div').attr("aria-valuenow", t).css("width", t + "%")), e <= -s.settings.timer && (clearInterval(i), s.close())
                }, s.settings.timer))
            },
            close: function() {
                var t = this,
                    ...
                    i = !1;
                this.$ele.attr("data-closing", "true").addClass(this.settings.animate.exit), t.reposition(e), a.isFunction(t.settings.onClose) && t.settings.onClose.call(this.$ele), this.$ele.one(this.animations.start, function() {
                    i = !0
                }).one(this.animations.end, function() {
            ...
            a(void 0 === t || "all" === t ? "[data-notify]" : "success" === t || "info" === t || "warning" === t || "danger" === t ? ".alert-" + t + "[data-notify]" : t ? t + "[data-notify]" : '[data-notify-position="' + t + '"]').find('[data-notify="dismiss"]').trigger("click")
    ...
    function(a) {
        ...
        e.Defaults = {
            ...
            var t, e, i, s, n, o;
            1 === this.core.settings.items && a.support.animation && a.support.transition && (this.core.speed(0), e = a.proxy(this.clear, this), i = this.core.$stage.children().eq(this.previous), s = this.core.$stage.children().eq(this.next), n = this.core.settings.animateIn, o = this.core.settings.animateOut, this.core.current() !== this.previous && (o && (t = this.core.coordinates(this.previous) - this.core.coordinates(this.next), i.one(a.support.animation.end, e).css({
                left: t + "px"
    ...
    function(t) {
        ...
        a.prototype = {
            ...
            toggleTouchEvent: function(t) {
                var e, i, s = this.toggleElement.offset().left;
    ...
    function(t, e) {
        ...
        s = Array.prototype.some || function(t) {
        ...
        function y(t, e) {
            var i, s, n;
            if (o(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), o(e._i) || (t._i = e._i), o(e._f) || (t._f = e._f), o(e._l) || (t._l = e._l), o(e._strict) || (t._strict = e._strict), o(e._tzm) || (t._tzm = e._tzm), o(e._isUTC) || (t._isUTC = e._isUTC), o(e._offset) || (t._offset = e._offset), o(e._pf) || (t._pf = m(e)), o(e._locale) || (t._locale = e._locale), 0 < v.length)
        ...
        p.suppressDeprecationWarnings = !1, p.deprecationHandler = null, n = Object.keys || function(t) {
            var e, i = [];
        ...
        function z(t, e) {
            return t.isValid() ? (e = B(e, t.localeData()), W[e] = W[e] || function(s) {
        ...
        function dt(t, i) {
            var e, s = i;
            for ("string" == typeof t && (t = [t]), l(i) && (s = function(t, e) {
                    e[i] = k(t)
                }), e = 0; e < t.length; e++) ct[t[e]] = s
        }
        ...
        }), j(0, ["YYYY", 4], 0, "year"), j(0, ["YYYYY", 5], 0, "year"), j(0, ["YYYYYY", 6, !0], 0, "year"), I("year", "y"), N("year", 1), lt("Y", st), lt("YY", Z, V), lt("YYYY", tt, G), lt("YYYYY", et, Q), lt("YYYYYY", et, Q), dt(["YYYYY", "YYYYYY"], ft), dt("YYYY", function(t, e) {
        ...
        function Et(t, e, i) {
            t.isValid() && !isNaN(i) && ("FullYear" === e && kt(t.year()) && 1 === t.month() && 29 === t.date() ? t._d["set" + (t._isUTC ? "UTC" : "") + e](i, t.month(), Mt(i, t.month())) : t._d["set" + (t._isUTC ? "UTC" : "") + e](i))
        }
        ...
        Ct = Array.prototype.indexOf || function(t) {
        ...
        }), I("month", "M"), N("month", 8), lt("M", Z), lt("MM", Z, V), lt("MMM", function(t, e) {
        ...
        function Ft() {
            ...
            this._monthsRegex = new RegExp("^(" + n.join("|") + ")", "i"), this._monthsShortRegex = this._monthsRegex, this._monthsStrictRegex = new RegExp("^(" + s.join("|") + ")", "i"), this._monthsShortStrictRegex = new RegExp("^(" + i.join("|") + ")", "i")
        }

        function Lt(t) {
            var e;
            return t < 100 && 0 <= t ? ((e = Array.prototype.slice.call(arguments))[0] = t + 400, e = new Date(Date.UTC.apply(null, e)), isFinite(e.getUTCFullYear()) && e.setUTCFullYear(t)) : e = new Date(Date.UTC.apply(null, arguments)), e
        }
        ...
        function Wt(t, e, i, s, n) {
            var o, n = 1 + 7 * (e - 1) + (7 + i - s) % 7 + Ht(t, s, n),
        ...
        function Rt(t, e, i) {
            var s, n, o = Ht(t.year(), e, i),
                o = Math.floor((t.dayOfYear() - o - 1) / 7) + 1;
            return o < 1 ? s = o + jt(n = t.year() - 1, e, i) : o > jt(t.year(), e, i) ? (s = o - jt(t.year(), e, i), n = t.year() + 1) : (n = t.year(), s = o), {
                week: s,
                year: n
            }
        }
        ...
        j("w", ["ww", 2], "wo", "week"), j("W", ["WW", 2], "Wo", "isoWeek"), I("week", "w"), I("isoWeek", "W"), N("week", 5), N("isoWeek", 5), lt("w", Z), lt("ww", Z, V), lt("W", Z), lt("WW", Z, V), ut(["w", "ww", "W", "WW"], function(t, e, i, s) {
            e[s.substr(0, 1)] = k(t)
        ...
        }), j("e", 0, 0, "weekday"), j("E", 0, 0, "isoWeekday"), I("day", "d"), I("weekday", "e"), I("isoWeekday", "E"), N("day", 11), N("weekday", 11), N("isoWeekday", 11), lt("d", Z), lt("e", Z), lt("E", Z), lt("dd", function(t, e) {
        ...
        function Zt() {
            ...
            for (var e, i, s, n = [], o = [], a = [], r = [], l = 0; l < 7; l++) s = u([2e3, 1]).day(l), e = this.weekdaysMin(s, ""), i = this.weekdaysShort(s, ""), s = this.weekdays(s, ""), n.push(e), o.push(i), a.push(s), r.push(e), r.push(i), r.push(s);
            for (n.sort(t), o.sort(t), a.sort(t), r.sort(t), l = 0; l < 7; l++) o[l] = ht(o[l]), a[l] = ht(a[l]), r[l] = ht(r[l]);
            this._weekdaysRegex = new RegExp("^(" + r.join("|") + ")", "i"), this._weekdaysShortRegex = this._weekdaysRegex, this._weekdaysMinRegex = this._weekdaysRegex, this._weekdaysStrictRegex = new RegExp("^(" + a.join("|") + ")", "i"), this._weekdaysShortStrictRegex = new RegExp("^(" + o.join("|") + ")", "i"), this._weekdaysMinStrictRegex = new RegExp("^(" + n.join("|") + ")", "i")
        }
        ...
        j("H", ["HH", 2], 0, "hour"), j("h", ["hh", 2], 0, Xt), j("k", ["kk", 2], 0, function() {
        ...
        }), Kt("a", !0), Kt("A", !1), I("hour", "h"), N("hour", 13), lt("a", Jt), lt("A", Jt), lt("H", Z), lt("h", Z), lt("k", Z), lt("HH", Z, V), lt("hh", Z, V), lt("kk", Z, V), lt("hmm", X), lt("hmmss", K), lt("Hmm", X), lt("Hmmss", K), dt(["H", "HH"], gt), dt(["k", "kk"], function(t, e, i) {
            t = k(t);
            e[gt] = 24 === t ? 0 : t
        ...
        function le(t, e) {
            ...
            var i, s = ie;
            if (e.abbr = t, null != se[t]) T("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), s = se[t]._config;
            else if (null != e.parentLocale)
                if (null != se[e.parentLocale]) s = se[e.parentLocale]._config;
                else {
                    if (null == (i = ae(e.parentLocale))) return ne[e.parentLocale] || (ne[e.parentLocale] = []), ne[e.parentLocale].push({
                        name: t,
                        config: e
                    }), null;
                    s = i._config
                } return se[t] = new O(M(s, e)), ne[t] && ne[t].forEach(function(t) {
                le(t.name, t.config)
            }), re(t), se[t]
        }
        ...
        function ce(t) {
            var e = t._a;
            return e && -2 === m(t).overflow && (e = e[pt] < 0 || 11 < e[pt] ? pt : e[mt] < 1 || e[mt] > Mt(e[ft], e[pt]) ? mt : e[gt] < 0 || 24 < e[gt] || 24 === e[gt] && (0 !== e[_t] || 0 !== e[vt] || 0 !== e[yt]) ? gt : e[_t] < 0 || 59 < e[_t] ? _t : e[vt] < 0 || 59 < e[vt] ? vt : e[yt] < 0 || 999 < e[yt] ? yt : -1, m(t)._overflowDayOfYear && (e < ft || mt < e) && (e = mt), m(t)._overflowWeeks && -1 === e && (e = wt), m(t)._overflowWeekday && -1 === e && (e = bt), m(t).overflow = e), t
        }
        ...
        function xe(t) {
            var e, i, s, n, o, a, r = we.exec(t._i.replace(/\([^)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").replace(/^\s\s*/, "").replace(/\s\s*$/, ""));
            r ? (e = r[4], i = r[3], s = r[2], n = r[5], o = r[6], a = r[7], o = [(e = parseInt(e, 10)) <= 49 ? 2e3 + e : e <= 999 ? 1900 + e : e, It.indexOf(i), parseInt(s, 10), parseInt(n, 10), parseInt(o, 10)], a && o.push(parseInt(a, 10)), n = s = o, a = t, (o = r[1]) && Ut.indexOf(o) !== new Date(n[0], n[1], n[2]).getDay() ? (m(a).weekdayMismatch = !0, a._isValid = !1) : (t._a = s, t._tzm = function(t, e, i) {
                if (t) return be[t];
                if (e) return 0;
                e = parseInt(i, 10), i = e % 100;
                return (e - i) / 100 * 60 + i
            }(r[8], r[9], r[10]), t._d = Lt.apply(null, t._a), t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), m(t).rfc2822 = !0)) : t._isValid = !1
        }
        ...
        function ke(t) {
            if (t._f !== p.ISO_8601)
                if (t._f !== p.RFC_2822) {
                    t._a = [], m(t).empty = !0;
                    for (var e, i, s, n = "" + t._i, o = n.length, a = 0, r = B(t._f, t._locale).match(L) || [], l = 0; l < r.length; l++) i = r[l], (e = (n.match((u = t, f(rt, d = i) ? rt[d](u._strict, u._locale) : new RegExp(ht(d.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function(t, e, i, s, n) {
                        return e || i || s || n
                    }))))) || [])[0]) && (0 < (s = n.substr(0, n.indexOf(e))).length && m(t).unusedInput.push(s), n = n.slice(n.indexOf(e) + e.length), a += e.length), R[i] ? (e ? m(t).empty = !1 : m(t).unusedTokens.push(i), u = i, d = t, null != (s = e) && f(ct, u) && ct[u](s, d._a, d, u)) : t._strict && !e && m(t).unusedTokens.push(i);
                    m(t).charsLeftOver = o - a, 0 < n.length && m(t).unusedInput.push(n), t._a[gt] <= 12 && !0 === m(t).bigHour && 0 < t._a[gt] && (m(t).bigHour = void 0), m(t).parsedDateParts = t._a.slice(0), m(t).meridiem = t._meridiem, t._a[gt] = (h = t._locale, c = t._a[gt], null == (o = t._meridiem) ? c : null != h.meridiemHour ? h.meridiemHour(c, o) : (null != h.isPM && ((o = h.isPM(o)) && c < 12 && (c += 12), o || 12 !== c || (c = 0)), c)), ue(t), ce(t)
                } else xe(t);
            else ye(t);
            var h, c, d, u
        }
        ...
        function Ce(t) {
            var e, i, s = t._i,
                n = t._f;
            return t._locale = t._locale || he(t._l), null === s || void 0 === n && "" === s ? _({
                nullInput: !0
            }) : ("string" == typeof s && (t._i = s = t._locale.preparse(s)), b(s) ? new w(ce(s)) : (h(s) ? t._d = s : a(n) ? function(t) {
                var e, i, s, n, o;
                if (0 === t._f.length) return m(t).invalidFormat = !0, t._d = new Date(NaN);
                for (n = 0; n < t._f.length; n++) o = 0, e = y({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[n], ke(e), g(e) && (o += m(e).charsLeftOver, o += 10 * m(e).unusedTokens.length, m(e).score = o, (null == s || o < s) && (s = o, i = e));
                d(t, i || e)
            }(t) : n ? ke(t) : o(n = (s = t)._i) ? s._d = new Date(p.now()) : h(n) ? s._d = new Date(n.valueOf()) : "string" == typeof n ? (e = s, null === (i = ve.exec(e._i)) ? (ye(e), !1 === e._isValid && (delete e._isValid, xe(e), !1 === e._isValid && (delete e._isValid, p.createFromInputFallback(e)))) : e._d = new Date(+i[1])) : a(n) ? (s._a = c(n.slice(0), function(t) {
                return parseInt(t, 10)
            }), ue(s)) : r(n) ? (e = s)._d || (i = A(e._i), e._a = c([i.year, i.month, i.day || i.date, i.hour, i.minute, i.second, i.millisecond], function(t) {
                return t && parseInt(t, 10)
            }), ue(e)) : l(n) ? s._d = new Date(n) : p.createFromInputFallback(s), g(t) || (t._d = null), t))
        }

        function De(t, e, i, s, n) {
            var o = {};
            return !0 !== i && !1 !== i || (s = i, i = void 0), (r(t) && function(t) {
                if (Object.getOwnPropertyNames) return 0 === Object.getOwnPropertyNames(t).length;
                for (var e in t)
                    if (t.hasOwnProperty(e)) return;
                return 1
            }(t) || a(t) && 0 === t.length) && (t = void 0), o._isAMomentObject = !0, o._useUTC = o._isUTC = n, o._l = i, o._i = t, o._f = e, o._strict = s, (o = new w(ce(Ce(o))))._nextDay && (o.add(1, "d"), o._nextDay = void 0), o
        }
        ...
        function Pe(t) {
            ...
            }(e), this._milliseconds = +t + 1e3 * h + 6e4 * l + 1e3 * r * 60 * 60, this._days = +a + 7 * o, this._months = +n + 3 * s + 12 * i, this._data = {}, this._locale = he(), this._bubble()
        }
        ...
        Ae("Z", ":"), Ae("ZZ", ""), lt("Z", ot), lt("ZZ", ot), dt(["Z", "ZZ"], function(t, e, i) {
        ...
        function je(t, e) {
            ...
            return Ie(t) ? n = {
                ...
                d: t._days,
                M: t._months
            } : l(t) ? (n = {}, e ? n[e] = t : n.milliseconds = t) : (o = We.exec(t)) ? (i = "-" === o[1] ? -1 : 1, n = {
                y: 0,
                d: k(o[mt]) * i,
                h: k(o[gt]) * i,
                m: k(o[_t]) * i,
                ...
                m: ze(o[7], i),
                s: ze(o[8], i)
            }) : null == n ? n = {} : "object" == typeof n && ("from" in n || "to" in n) && (o = Se(n.from), i = Se(n.to), s = o.isValid() && i.isValid() ? (i = Fe(i, o), o.isBefore(i) ? s = Be(o, i) : ((s = Be(i, o)).milliseconds = -s.milliseconds, s.months = -s.months), s) : {
                milliseconds: 0,
                months: 0
            }, (n = {}).ms = s.milliseconds, n.M = s.months), n = new Pe(n), Ie(t) && f(t, "_locale") && (n._locale = t._locale), n
        }
        ...
        function Ue(s, n) {
            return function(t, e) {
                var i;
                return null === e || isNaN(+e) || (T(n, "moment()." + n + "(period, number) is deprecated. Please use moment()." + n + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), i = t, t = e, e = i), Ve(this, je(t = "string" == typeof t ? +t : t, e), s), this
            }
        }
        ...
        je.fn = Pe.prototype, je.invalid = function() {
            return je(NaN)
        };
        var qe = Ue(1, "add"),
            at = Ue(-1, "subtract");
        ...
        function ii(t, e, i, s, n) {
            var o;
            return null == t ? Rt(this, s, n).year : ((o = jt(t, s, n)) < e && (e = o), function(t, e, i, s, n) {
        ...
        }), ei("gggg", "weekYear"), ei("ggggg", "weekYear"), ei("GGGG", "isoWeekYear"), ei("GGGGG", "isoWeekYear"), I("weekYear", "gg"), I("isoWeekYear", "GG"), N("weekYear", 1), N("isoWeekYear", 1), lt("G", st), lt("g", st), lt("GG", Z, V), lt("gg", Z, V), lt("GGGG", tt, G), lt("gggg", tt, G), lt("GGGGG", et, Q), lt("ggggg", et, Q), ut(["gggg", "ggggg", "GGGG", "GGGGG"], function(t, e, i, s) {
            e[s.substr(0, 2)] = k(t)
        }), ut(["gg", "GG"], function(t, e, i, s) {
            e[s] = p.parseTwoDigitYear(t)
        }), j("Q", 0, "Qo", "quarter"), I("quarter", "Q"), N("quarter", 7), lt("Q", U), dt("Q", function(t, e) {
            e[pt] = 3 * (k(t) - 1)
        }), j("D", ["DD", 2], "Do", "date"), I("date", "D"), N("date", 9), lt("D", Z), lt("DD", Z, V), lt("Do", function(t, e) {
            return t ? e._dayOfMonthOrdinalParse || e._ordinalParse : e._dayOfMonthOrdinalParseLenient
        }), dt(["D", "DD"], mt), dt("Do", function(t, e) {
            e[mt] = k(t.match(Z)[0])
        });
        K = St("Date", !0);
        j("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), I("dayOfYear", "DDD"), N("dayOfYear", 4), lt("DDD", J), lt("DDDD", q), dt(["DDD", "DDDD"], function(t, e, i) {
            i._dayOfYear = k(t)
        }), j("m", ["mm", 2], 0, "minute"), I("minute", "m"), N("minute", 14), lt("m", Z), lt("mm", Z, V), dt(["m", "mm"], _t);
        Pt = St("Minutes", !1);
        j("s", ["ss", 2], 0, "second"), I("second", "s"), N("second", 15), lt("s", Z), lt("ss", Z, V), dt(["s", "ss"], vt);
        var si, Bt = St("Seconds", !1);
        for (j("S", 0, 0, function() {
            ...
            }), I("millisecond", "ms"), N("millisecond", 16), lt("S", J, U), lt("SS", J, V), lt("SSS", J, q), si = "SSSS"; si.length <= 9; si += "S") lt(si, it);
        ...
        tt.add = qe, tt.calendar = function(t, e) {
            var i = t || Se(),
            ...
            return this.isValid() && (b(t) && t.isValid() || Se(t).isValid()) ? je({
                to: this,
                from: t
            ...
            var t = b(t) ? t : Se(t);
            return !(!this.isValid() || !t.isValid()) && ("millisecond" === (e = $(e) || "millisecond") ? this.valueOf() === t.valueOf() : (t = t.valueOf(), this.clone().startOf(e).valueOf() <= t && t <= this.clone().endOf(e).valueOf()))
            ...
            return g(this)
        }, tt.lang = X, tt.locale = Qe, tt.localeData = Ze, tt.max = Ee, tt.min = Te, tt.parsingFlags = function() {
            return d({}, m(this))
        }, tt.set = function(i, t) {
            if ("object" == typeof i)
                for (var e = function() {
                        var t, e = [];
                        for (t in i = A(i)) e.push({
                            unit: t,
                            priority: Y[t]
                        });
                    ...
                    }(), s = 0; s < e.length; s++) this[e[s].unit](i[e[s].unit]);
            ...
            return this._d.setTime(e), p.updateOffset(this, !0), this
        }, tt.subtract = at, tt.toArray = function() {
            ...
            return t.year() < 0 || 9999 < t.year() ? z(t, e ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : E(Date.prototype.toISOString) ? e ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", z(t, "Z")) : z(t, e ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
        }, tt.inspect = function() {
        ...
        }, tt.year = Dt, tt.isLeapYear = function() {
            return kt(this.year())
        ...
        }, tt.month = At, tt.daysInMonth = function() {
        ...
        }, tt.date = K, tt.day = tt.days = function(t) {
            ...
            return null == t ? e : this.add(t - e, "d")
        }, tt.hour = tt.hours = ee, tt.minute = tt.minutes = Pt, tt.second = tt.seconds = Bt, tt.millisecond = tt.milliseconds = Vt, tt.utcOffset = function(t, e, i) {
            ...
            return !this._isUTC && e && (s = Le(this)), this._offset = t, this._isUTC = !0, null != s && this.add(s, "m"), n !== t && (!e || this._changeInProgress ? Ve(this, je(t - n, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, p.updateOffset(this, !0), this._changeInProgress = null)), this
        }, tt.utc = function(t) {
            ...
            return !!this.isValid() && this._isUTC
        }, tt.isUtc = He, tt.isUTC = He, tt.zoneAbbr = function() {
            return this._isUTC ? "UTC" : ""
        }, tt.zoneName = function() {
            return this._isUTC ? "Coordinated Universal Time" : ""
        }, tt.dates = i("dates accessor is deprecated. Use date instead.", K), tt.months = i("months accessor is deprecated. Use month instead", At), tt.years = i("years accessor is deprecated. Use year instead", Dt), tt.zone = i("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function(t, e) {
        ...
        G.calendar = function(t, e, i) {
        ...
        }, G.preparse = oi, G.postformat = oi, G.relativeTime = function(t, e, i, s) {
            ...
            if (this._monthsParseExact) return function(t, e, i) {
                var s, n, o, t = t.toLocaleLowerCase();
                ...
                return i ? "MMM" === e ? -1 !== (n = Ct.call(this._shortMonthsParse, t)) ? n : null : -1 !== (n = Ct.call(this._longMonthsParse, t)) ? n : null : "MMM" === e ? -1 !== (n = Ct.call(this._shortMonthsParse, t)) || -1 !== (n = Ct.call(this._longMonthsParse, t)) ? n : null : -1 !== (n = Ct.call(this._longMonthsParse, t)) || -1 !== (n = Ct.call(this._shortMonthsParse, t)) ? n : null
            }.call(this, t, e, i);
            ...
            return this._monthsParseExact ? (f(this, "_monthsRegex") || Ft.call(this), t ? this._monthsStrictRegex : this._monthsRegex) : (f(this, "_monthsRegex") || (this._monthsRegex = Nt), this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex)
        }, G.monthsShortRegex = function(t) {
            return this._monthsParseExact ? (f(this, "_monthsRegex") || Ft.call(this), t ? this._monthsShortStrictRegex : this._monthsShortRegex) : (f(this, "_monthsShortRegex") || (this._monthsShortRegex = Yt), this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex)
        }, G.week = function(t) {
            ...
            return this._weekdaysParseExact ? (f(this, "_weekdaysRegex") || Zt.call(this), t ? this._weekdaysStrictRegex : this._weekdaysRegex) : (f(this, "_weekdaysRegex") || (this._weekdaysRegex = qt), this._weekdaysStrictRegex && t ? this._weekdaysStrictRegex : this._weekdaysRegex)
        }, G.weekdaysShortRegex = function(t) {
            return this._weekdaysParseExact ? (f(this, "_weekdaysRegex") || Zt.call(this), t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (f(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Gt), this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
        ...
        }), p.lang = i("moment.lang is deprecated. Use moment.locale instead.", re), p.langData = i("moment.langData is deprecated. Use moment.localeData instead.", he);
        var hi = Math.abs;
        ...
        return G.isValid = function() {
            ...
            if ("month" === (t = $(t)) || "quarter" === t || "year" === t) switch (e = this._days + s / 864e5, i = this._months + ui(e), t) {
                case "month":
                    return i;
                case "quarter":
                    return i / 3;
                case "year":
                    return i / 12
            } else switch (e = this._days + Math.round(fi(this._months)), t) {
                case "week":
                    return e / 7 + s / 6048e5;
                case "day":
                    return e + s / 864e5;
        ...
        }, G.asMilliseconds = et, G.asSeconds = Q, G.asMinutes = U, G.asHours = V, G.asDays = J, G.asWeeks = q, G.asMonths = qe, G.asQuarters = Ee, G.asYears = Te, G.valueOf = function() {
            ...
            var t = this._milliseconds,
                ...
                i = this._months,
                s = this._data;
            return 0 <= t && 0 <= e && 0 <= i || t <= 0 && e <= 0 && i <= 0 || (t += 864e5 * di(fi(i) + e), i = e = 0), s.milliseconds = t % 1e3, t = x(t / 1e3), s.seconds = t % 60, t = x(t / 60), s.minutes = t % 60, t = x(t / 60), s.hours = t % 24, i += t = x(ui(e += x(t / 24))), e -= di(fi(t)), t = x(i / 12), i %= 12, s.days = e, s.months = i, s.years = t, this
        }, G.clone = function() {
            return je(this)
        }, G.get = function(t) {
            return t = $(t), this.isValid() ? this[t + "s"]() : NaN
        }, G.milliseconds = at, G.seconds = ee, G.minutes = Pt, G.hours = Bt, G.days = Vt, G.weeks = function() {
            return x(this.days() / 7)
        }, G.months = K, G.years = Dt, G.humanize = function(t) {
            if (!this.isValid()) return this.localeData().invalidDate();
            var e, i, s, n, o, a, r, l = this.localeData(),
                h = (e = !t, i = l, h = je(this).abs(), s = gi(h.as("s")), n = gi(h.as("m")), o = gi(h.as("h")), a = gi(h.as("d")), r = gi(h.as("M")), h = gi(h.as("y")), (h = (s <= _i.ss ? ["s", s] : s < _i.s && ["ss", s]) || n <= 1 && ["m"] || n < _i.m && ["mm", n] || o <= 1 && ["h"] || o < _i.h && ["hh", o] || a <= 1 && ["d"] || a < _i.d && ["dd", a] || r <= 1 && ["M"] || r < _i.M && ["MM", r] || h <= 1 && ["y"] || ["yy", h])[2] = e, h[3] = 0 < +this, h[4] = i, function(t, e, i, s, n) {
                    return n.relativeTime(e || 1, !!i, t, s)
                }.apply(null, h));
            return t && (h = l.pastFuture(+this, h)), l.postformat(h)
        }, G.toISOString = wi, G.toString = wi, G.toJSON = wi, G.locale = Qe, G.localeData = Ze, G.toIsoString = i("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", wi), G.lang = X, j("X", 0, 0, "unix"), j("x", 0, 0, "valueOf"), lt("x", st), lt("X", /[+-]?\d+(\.\d{1,3})?/), dt("X", function(t, e, i) {
            i._d = new Date(1e3 * parseFloat(t, 10))
        }), dt("x", function(t, e, i) {
            i._d = new Date(k(t))
        }), p.version = "2.24.0", t = Se, p.fn = tt, p.min = function() {
            return Me("isBefore", [].slice.call(arguments, 0))
        }, p.max = function() {
            return Me("isAfter", [].slice.call(arguments, 0))
        }, p.now = function() {
            return Date.now ? Date.now() : +new Date
        }, p.utc = u, p.unix = function(t) {
            return Se(1e3 * t)
        }, p.months = function(t, e) {
            return ri(t, e, "months")
        }, p.isDate = h, p.locale = re, p.invalid = _, p.duration = je, p.isMoment = b, p.weekdays = function(t, e, i) {
            return li(t, e, i, "weekdays")
        }, p.parseZone = function() {
            return Se.apply(null, arguments).parseZone()
        }, p.localeData = he, p.isDuration = Ie, p.monthsShort = function(t, e) {
            return ri(t, e, "monthsShort")
        }, p.weekdaysMin = function(t, e, i) {
            return li(t, e, i, "weekdaysMin")
        }, p.defineLocale = le, p.updateLocale = function(t, e) {
            var i, s;
            return null != e ? (s = ie, null != (i = ae(t)) && (s = i._config), (e = new O(e = M(s, e))).parentLocale = se[t], se[t] = e, re(t)) : null != se[t] && (null != se[t].parentLocale ? se[t] = se[t].parentLocale : null != se[t] && delete se[t]), se[t]
        }, p.locales = function() {
            return n(se)
        }, p.weekdaysShort = function(t, e, i) {
            return li(t, e, i, "weekdaysShort")
        }, p.normalizeUnits = $, p.relativeTimeRounding = function(t) {
    ...
    function(t, i) {
        ...
        }) : "object" == typeof module && module.exports ? ((e = "undefined" != typeof window ? window.jQuery : void 0) || (e = require("jquery")).fn || (e.fn = {}), s = "undefined" != typeof window && void 0 !== window.moment ? window.moment : require("moment"), module.exports = i(s, e)) : t.daterangepicker = i(t.moment, t.jQuery)
    }("undefined" != typeof window ? window : this, function(P, I) {
        function s(t, e, i) {
            var s, n, o, a;
            if (this.parentEl = "body", this.element = I(t), this.startDate = P().startOf("day"), this.endDate = P().endOf("day"), this.minDate = !1, this.maxDate = !1, this.maxSpan = !1, this.autoApply = !1, this.singleDatePicker = !1, this.showDropdowns = !1, this.minYear = P().subtract(100, "year").format("YYYY"), this.maxYear = P().add(100, "year").format("YYYY"), this.showWeekNumbers = !1, this.showISOWeekNumbers = !1, this.showCustomRangeLabel = !0, this.timePicker = !1, this.timePicker24Hour = !1, this.timePickerIncrement = 1, this.timePickerSeconds = !1, this.linkedCalendars = !0, this.autoUpdateInput = !0, this.alwaysShowCalendars = !1, this.ranges = {}, this.opens = "right", this.element.hasClass("pull-right") && (this.opens = "left"), this.drops = "down", this.element.hasClass("dropup") && (this.drops = "up"), this.buttonClasses = "btn btn-sm", this.applyButtonClasses = "btn-primary", this.cancelButtonClasses = "btn-default", this.locale = {
                    direction: "ltr",
            ...
            if (void 0 === e.startDate && void 0 === e.endDate && I(this.element).is(":text") && (a = s = null, 2 == (t = (o = I(this.element).val()).split(this.locale.separator)).length ? (a = P(t[0], this.locale.format), s = P(t[1], this.locale.format)) : this.singleDatePicker && "" !== o && (a = P(o, this.locale.format), s = P(o, this.locale.format)), null !== a && null !== s && (this.setStartDate(a), this.setEndDate(s))), "object" == typeof e.ranges) {
                for (n in e.ranges) {
                    a = "string" == typeof e.ranges[n][0] ? P(e.ranges[n][0], this.locale.format) : P(e.ranges[n][0]), s = "string" == typeof e.ranges[n][1] ? P(e.ranges[n][1], this.locale.format) : P(e.ranges[n][1]), this.minDate && a.isBefore(this.minDate) && (a = this.minDate.clone());
                    var l, h, c = this.maxDate;
                    this.maxSpan && c && a.clone().add(this.maxSpan).isAfter(c) && (c = a.clone().add(this.maxSpan)), c && s.isAfter(c) && (s = c.clone()), this.minDate && s.isBefore(this.minDate, this.timepicker ? "minute" : "day") || c && a.isAfter(c, this.timepicker ? "minute" : "day") || ((l = document.createElement("textarea")).innerHTML = n, h = l.value, this.ranges[h] = [a, s])
                }
                var d = "<ul>";
            ...
            "function" == typeof i && (this.callback = i), this.timePicker || (this.startDate = this.startDate.startOf("day"), this.endDate = this.endDate.endOf("day"), this.container.find(".calendar-time").hide()), this.timePicker && this.autoApply && (this.autoApply = !1), this.autoApply && this.container.addClass("auto-apply"), "object" == typeof e.ranges && this.container.addClass("show-ranges"), this.singleDatePicker && (this.container.addClass("single"), this.container.find(".drp-calendar.left").addClass("single"), this.container.find(".drp-calendar.left").show(), this.container.find(".drp-calendar.right").hide(), !this.timePicker && this.autoApply && this.container.addClass("auto-apply")), (void 0 === e.ranges && !this.singleDatePicker || this.alwaysShowCalendars) && this.container.addClass("show-calendar"), this.container.addClass("opens" + this.opens), this.container.find(".applyBtn, .cancelBtn").addClass(this.buttonClasses), this.applyButtonClasses.length && this.container.find(".applyBtn").addClass(this.applyButtonClasses), this.cancelButtonClasses.length && this.container.find(".cancelBtn").addClass(this.cancelButtonClasses), this.container.find(".applyBtn").html(this.locale.applyLabel), this.container.find(".cancelBtn").html(this.locale.cancelLabel), this.container.find(".drp-calendar").on("click.daterangepicker", ".prev", I.proxy(this.clickPrev, this)).on("click.daterangepicker", ".next", I.proxy(this.clickNext, this)).on("mousedown.daterangepicker", "td.available", I.proxy(this.clickDate, this)).on("mouseenter.daterangepicker", "td.available", I.proxy(this.hoverDate, this)).on("change.daterangepicker", "select.yearselect", I.proxy(this.monthOrYearChanged, this)).on("change.daterangepicker", "select.monthselect", I.proxy(this.monthOrYearChanged, this)).on("change.daterangepicker", "select.hourselect,select.minuteselect,select.secondselect,select.ampmselect", I.proxy(this.timeChanged, this)), this.container.find(".ranges").on("click.daterangepicker", "li", I.proxy(this.clickRange, this)), this.container.find(".drp-buttons").on("click.daterangepicker", "button.applyBtn", I.proxy(this.clickApply, this)).on("click.daterangepicker", "button.cancelBtn", I.proxy(this.clickCancel, this)), this.element.is("input") || this.element.is("button") ? this.element.on({
            ...
            }) : (this.element.on("click.daterangepicker", I.proxy(this.toggle, this)), this.element.on("keydown.daterangepicker", I.proxy(this.toggle, this))), this.updateElement()
        }
        return s.prototype = {
            constructor: s,
            setStartDate: function(t) {
                "string" == typeof t && (this.startDate = P(t, this.locale.format)), "object" == typeof t && (this.startDate = P(t)), this.timePicker || (this.startDate = this.startDate.startOf("day")), this.timePicker && this.timePickerIncrement && this.startDate.minute(Math.round(this.startDate.minute() / this.timePickerIncrement) * this.timePickerIncrement), this.minDate && this.startDate.isBefore(this.minDate) && (this.startDate = this.minDate.clone(), this.timePicker && this.timePickerIncrement && this.startDate.minute(Math.round(this.startDate.minute() / this.timePickerIncrement) * this.timePickerIncrement)), this.maxDate && this.startDate.isAfter(this.maxDate) && (this.startDate = this.maxDate.clone(), this.timePicker && this.timePickerIncrement && this.startDate.minute(Math.floor(this.startDate.minute() / this.timePickerIncrement) * this.timePickerIncrement)), this.isShowing || this.updateElement(), this.updateMonthsInView()
            },
            setEndDate: function(t) {
                "string" == typeof t && (this.endDate = P(t, this.locale.format)), "object" == typeof t && (this.endDate = P(t)), this.timePicker || (this.endDate = this.endDate.endOf("day")), this.timePicker && this.timePickerIncrement && this.endDate.minute(Math.round(this.endDate.minute() / this.timePickerIncrement) * this.timePickerIncrement), this.endDate.isBefore(this.startDate) && (this.endDate = this.startDate.clone()), this.maxDate && this.endDate.isAfter(this.maxDate) && (this.endDate = this.maxDate.clone()), this.maxSpan && this.startDate.clone().add(this.maxSpan).isBefore(this.endDate) && (this.endDate = this.startDate.clone().add(this.maxSpan)), this.previousRightTime = this.endDate.clone(), this.container.find(".drp-selected").html(this.startDate.format(this.locale.format) + this.locale.separator + this.endDate.format(this.locale.format)), this.isShowing || this.updateElement(), this.updateMonthsInView()
            },
            ...
            renderCalendar: function(t) {
                ...
                _ += "<thead>", _ += "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (_ += "<th></th>"), m && !m.isBefore(e.firstDay) || this.linkedCalendars && "left" != t ? _ += "<th></th>" : _ += '<th class="prev available"><span></span></th>';
                c = this.locale.monthNames[e[1][1].month()] + e[1][1].format(" YYYY");
                if (this.showDropdowns) {
                    for (var v = e[1][1].month(), y = e[1][1].year(), w = g && g.year() || this.maxYear, h = m && m.year() || this.minYear, b = y == h, x = y == w, k = '<select class="monthselect">', C = 0; C < 12; C++)(!b || m && C >= m.month()) && (!x || g && C <= g.month()) ? k += "<option value='" + C + "'" + (C === v ? " selected='selected'" : "") + ">" + this.locale.monthNames[C] + "</option>" : k += "<option value='" + C + "'" + (C === v ? " selected='selected'" : "") + " disabled='disabled'>" + this.locale.monthNames[C] + "</option>";
                    k += "</select>";
                    for (var D = '<select class="yearselect">', S = h; S <= w; S++) D += '<option value="' + S + '"' + (S === y ? ' selected="selected"' : "") + ">" + S + "</option>";
                    c = k + (D += "</select>")
                }
                _ += '<th colspan="5" class="month">' + c + "</th>", g && !g.isAfter(e.lastDay) || this.linkedCalendars && "right" != t && !this.singleDatePicker ? _ += "<th></th>" : _ += '<th class="next available"><span></span></th>', _ += "</tr>", _ += "<tr>", (this.showWeekNumbers || this.showISOWeekNumbers) && (_ += '<th class="week">' + this.locale.weekLabel + "</th>"), I.each(this.locale.daysOfWeek, function(t, e) {
                    _ += "<th>" + e + "</th>"
                }), _ += "</tr>", _ += "</thead>", _ += "<tbody>", null == this.endDate && this.maxSpan && (c = this.startDate.clone().add(this.maxSpan).endOf("day"), g && !c.isBefore(g) || (g = c));
                for (p = 0; p < 6; p++) {
                    _ += "<tr>", this.showWeekNumbers ? _ += '<td class="week">' + e[p][0].week() + "</td>" : this.showISOWeekNumbers && (_ += '<td class="week">' + e[p][0].isoWeek() + "</td>");
                    for (f = 0; f < 7; f++) {
                        var T = [];
                        e[p][f].isSame(new Date, "day") && T.push("today"), 5 < e[p][f].isoWeekday() && T.push("weekend"), e[p][f].month() != e[1][1].month() && T.push("off", "ends"), this.minDate && e[p][f].isBefore(this.minDate, "day") && T.push("off", "disabled"), g && e[p][f].isAfter(g, "day") && T.push("off", "disabled"), this.isInvalidDate(e[p][f]) && T.push("off", "disabled"), e[p][f].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && T.push("active", "start-date"), null != this.endDate && e[p][f].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && T.push("active", "end-date"), null != this.endDate && e[p][f] > this.startDate && e[p][f] < this.endDate && T.push("in-range");
                ...
                if ("right" != t || this.endDate) {
                    ...
                    for (var o = this.timePicker24Hour ? 0 : 1, a = this.timePicker24Hour ? 23 : 12, r = o; r <= a; r++) {
                        ...
                        var h = i.clone().hour(l),
                            c = !1;
                        s && h.minute(59).isBefore(s) && (c = !0), n && h.minute(0).isAfter(n) && (c = !0), l != i.hour() || c ? e += c ? '<option value="' + r + '" disabled="disabled" class="disabled">' + r + "</option>" : '<option value="' + r + '">' + r + "</option>" : e += '<option value="' + r + '" selected="selected">' + r + "</option>"
                    }
                    ...
                    for (var d, r = 0; r < 60; r += this.timePickerIncrement) {
                        var u = r < 10 ? "0" + r : r,
                            h = i.clone().minute(r),
                            c = !1;
                        s && h.second(59).isBefore(s) && (c = !0), n && h.second(0).isAfter(n) && (c = !0), i.minute() != r || c ? e += c ? '<option value="' + r + '" disabled="disabled" class="disabled">' + u + "</option>" : '<option value="' + r + '">' + u + "</option>" : e += '<option value="' + r + '" selected="selected">' + u + "</option>"
                    }
                    if (e += "</select> ", this.timePickerSeconds) {
                        e += ': <select class="secondselect">';
                        for (r = 0; r < 60; r++) {
                            u = r < 10 ? "0" + r : r, h = i.clone().second(r), c = !1;
                            s && h.isBefore(s) && (c = !0), n && h.isAfter(n) && (c = !0), i.second() != r || c ? e += c ? '<option value="' + r + '" disabled="disabled" class="disabled">' + u + "</option>" : '<option value="' + r + '">' + u + "</option>" : e += '<option value="' + r + '" selected="selected">' + u + "</option>"
                        }
                        e += "</select> "
                    }
                    this.timePicker24Hour || (e += '<select class="ampmselect">', o = d = "", s && i.clone().hour(12).minute(0).second(0).isBefore(s) && (d = ' disabled="disabled" class="disabled"'), n && i.clone().hour(0).minute(0).second(0).isAfter(n) && (o = ' disabled="disabled" class="disabled"'), 12 <= i.hour() ? e += '<option value="AM"' + d + '>AM</option><option value="PM" selected="selected"' + o + ">PM</option>" : e += '<option value="AM" selected="selected"' + d + '>AM</option><option value="PM"' + o + ">PM</option>", e += "</select>"), this.container.find(".drp-calendar." + t + " .calendar-time").html(e)
                }
            },
            ...
            move: function() {
                ...
                var n, o = this.container.outerWidth();
                this.container.toggleClass("drop-up", "up" == i), "left" == this.opens ? o + (s = s - this.element.offset().left - this.element.outerWidth()) > I(window).width() ? this.container.css({
                    top: t,
                    right: "auto",
                    left: 9
                }) : this.container.css({
                    ...
                    right: "auto",
                    left: 9
                }) : n + o > I(window).width() ? this.container.css({
                    top: t,
                    left: "auto",
                    right: 0
                }) : this.container.css({
                    ...
                    left: n,
                    right: "auto"
                }) : (n = this.element.offset().left - e.left) + o > I(window).width() ? this.container.css({
                    top: t,
                    left: "auto",
                    right: 0
                }) : this.container.css({
            ...
            hide: function(t) {
                this.isShowing && (this.endDate || (this.startDate = this.oldStartDate.clone(), this.endDate = this.oldEndDate.clone()), this.startDate.isSame(this.oldStartDate) && this.endDate.isSame(this.oldEndDate) || this.callback(this.startDate.clone(), this.endDate.clone(), this.chosenLabel), this.updateElement(), I(document).off(".daterangepicker"), I(window).off(".daterangepicker"), this.container.hide(), this.element.trigger("hide.daterangepicker", this), this.isShowing = !1)
            },
            toggle: function(t) {
            ...
            clickPrev: function(t) {
                I(t.target).parents(".drp-calendar").hasClass("left") ? (this.leftCalendar.month.subtract(1, "month"), this.linkedCalendars && this.rightCalendar.month.subtract(1, "month")) : this.rightCalendar.month.subtract(1, "month"), this.updateCalendars()
            },
            clickNext: function(t) {
                I(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.month.add(1, "month") : (this.rightCalendar.month.add(1, "month"), this.linkedCalendars && this.leftCalendar.month.add(1, "month")), this.updateCalendars()
            },
            hoverDate: function(t) {
                var e, i, n, o, a, r;
                I(t.target).hasClass("available") && (e = (i = I(t.target).attr("data-title")).substr(1, 1), i = i.substr(3, 1), n = (I(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar : this.rightCalendar).calendar[e][i], o = this.leftCalendar, a = this.rightCalendar, r = this.startDate, this.endDate || this.container.find(".drp-calendar tbody td").each(function(t, e) {
                    var i, s;
                    I(e).hasClass("week") || (i = (s = I(e).attr("data-title")).substr(1, 1), s = s.substr(3, 1), (s = (I(e).parents(".drp-calendar").hasClass("left") ? o : a).calendar[i][s]).isAfter(r) && s.isBefore(n) || s.isSame(n, "day") ? I(e).addClass("in-range") : I(e).removeClass("in-range"))
                }))
            },
            clickDate: function(t) {
                var e, i, s, n, o, a;
                I(t.target).hasClass("available") && (e = (i = I(t.target).attr("data-title")).substr(1, 1), i = i.substr(3, 1), i = (I(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar : this.rightCalendar).calendar[e][i], this.endDate || i.isBefore(this.startDate, "day") ? (this.timePicker && (s = parseInt(this.container.find(".left .hourselect").val(), 10), this.timePicker24Hour || ("PM" === (n = this.container.find(".left .ampmselect").val()) && s < 12 && (s += 12), "AM" === n && 12 === s && (s = 0)), o = parseInt(this.container.find(".left .minuteselect").val(), 10), isNaN(o) && (o = parseInt(this.container.find(".left .minuteselect option:last").val(), 10)), a = this.timePickerSeconds ? parseInt(this.container.find(".left .secondselect").val(), 10) : 0, i = i.clone().hour(s).minute(o).second(a)), this.endDate = null, this.setStartDate(i.clone())) : !this.endDate && i.isBefore(this.startDate) ? this.setEndDate(this.startDate.clone()) : (this.timePicker && (s = parseInt(this.container.find(".right .hourselect").val(), 10), this.timePicker24Hour || ("PM" === (n = this.container.find(".right .ampmselect").val()) && s < 12 && (s += 12), "AM" === n && 12 === s && (s = 0)), o = parseInt(this.container.find(".right .minuteselect").val(), 10), isNaN(o) && (o = parseInt(this.container.find(".right .minuteselect option:last").val(), 10)), a = this.timePickerSeconds ? parseInt(this.container.find(".right .secondselect").val(), 10) : 0, i = i.clone().hour(s).minute(o).second(a)), this.setEndDate(i.clone()), this.autoApply && (this.calculateChosenLabel(), this.clickApply())), this.singleDatePicker && (this.setEndDate(this.startDate), !this.timePicker && this.autoApply && this.clickApply()), this.updateView(), t.stopPropagation())
            },
            ...
            timeChanged: function(t) {
                ...
                var o, t = this.timePickerSeconds ? parseInt(e.find(".secondselect").val(), 10) : 0;
                this.timePicker24Hour || ("PM" === (e = e.find(".ampmselect").val()) && s < 12 && (s += 12), "AM" === e && 12 === s && (s = 0)), i ? ((o = this.startDate.clone()).hour(s), o.minute(n), o.second(t), this.setStartDate(o), this.singleDatePicker ? this.endDate = this.startDate.clone() : this.endDate && this.endDate.format("YYYY-MM-DD") == o.format("YYYY-MM-DD") && this.endDate.isBefore(o) && this.setEndDate(o.clone())) : this.endDate && ((o = this.endDate.clone()).hour(s), o.minute(n), o.second(t), this.setEndDate(o)), this.updateCalendars(), this.updateFormInputs(), this.renderTimePicker("left"), this.renderTimePicker("right")
            },
            elementChanged: function() {
                var t, e, i;
                this.element.is("input") && this.element.val().length && (i = e = null, 2 === (t = this.element.val().split(this.locale.separator)).length && (e = P(t[0], this.locale.format), i = P(t[1], this.locale.format)), !this.singleDatePicker && null !== e && null !== i || (i = e = P(this.element.val(), this.locale.format)), e.isValid() && i.isValid() && (this.setStartDate(e), this.setEndDate(i), this.updateView()))
            },
            keydown: function(t) {
        ...
        o.prototype = {
            ...
            _init: function() {
                ...
                this.showWidgetOnAddonClick && (this.$element.parent().hasClass("input-append") || this.$element.parent().hasClass("input-prepend")) ? (this.$element.parent(".input-append, .input-prepend").find(".add-on").on({
                    ...
                    "blur.timepicker": d.proxy(this.blurElement, this),
                    "mousewheel.timepicker DOMMouseScroll.timepicker": d.proxy(this.mousewheel, this)
                }), !1 !== this.template ? this.$widget = d(this.getTemplate()).on("click", d.proxy(this.widgetClick, this)) : this.$widget = !1, this.showInputs && !1 !== this.$widget && this.$widget.find("input").each(function() {
                    d(this).on({
            ...
            getTemplate: function() {
                var t, e, i, s, n = this.showInputs ? (e = '<input type="text" class="bootstrap-timepicker-hour" maxlength="2"/>', i = '<input type="text" class="bootstrap-timepicker-minute" maxlength="2"/>', s = '<input type="text" class="bootstrap-timepicker-second" maxlength="2"/>', '<input type="text" class="bootstrap-timepicker-meridian" maxlength="2"/>') : (e = '<span class="bootstrap-timepicker-hour"></span>', i = '<span class="bootstrap-timepicker-minute"></span>', s = '<span class="bootstrap-timepicker-second"></span>', '<span class="bootstrap-timepicker-meridian"></span>'),
                    o = '<table><tr><td><a href="#" data-action="incrementHour"><i class="icon-up-open-big"></i></a></td><td class="separator">&nbsp;</td><td><a href="#" data-action="incrementMinute"><i class="icon-up-open-big"></i></a></td>' + (this.showSeconds ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="incrementSecond"><i class="icon-up-open-big"></i></a></td>' : "") + (this.showMeridian ? '<td class="separator">&nbsp;</td><td class="meridian-column"><a href="#" data-action="toggleMeridian"><i class="icon-up-open-big"></i></a></td>' : "") + "</tr><tr><td>" + e + '</td> <td class="separator">:</td><td>' + i + "</td> " + (this.showSeconds ? '<td class="separator">:</td><td>' + s + "</td>" : "") + (this.showMeridian ? '<td class="separator">&nbsp;</td><td>' + n + "</td>" : "") + '</tr><tr><td><a href="#" data-action="decrementHour"><i class="icon-down-open-big"></i></a></td><td class="separator"></td><td><a href="#" data-action="decrementMinute"><i class="icon-down-open-big"></i></a></td>' + (this.showSeconds ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="decrementSecond"><i class="icon-down-open-big"></i></a></td>' : "") + (this.showMeridian ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="toggleMeridian"><i class="icon-down-open-big"></i></a></td>' : "") + "</tr></table>";
            ...
            hideWidget: function() {
                ...
                }), "modal" === this.template && this.$widget.modal ? this.$widget.modal("hide") : this.$widget.removeClass("open"), d(s).off("mousedown.timepicker, touchend.timepicker"), this.isOpen = !1, this.$widget.detach())
            },
            ...
            mousewheel: function(t) {
                if (!this.disableMousewheel) {
                    ...
                    var e = t.originalEvent.wheelDelta || -t.originalEvent.detail,
                        i = null;
                    switch ("mousewheel" === t.type ? i = -1 * t.originalEvent.wheelDelta : "DOMMouseScroll" === t.type && (i = 40 * t.originalEvent.detail), i && (t.preventDefault(), d(this).scrollTop(i + d(this).scrollTop())), this.highlightedUnit) {
                        case "minute":
            ...
            place: function() {
                ...
                this.isInline || (h = this.$widget.outerWidth(), t = this.$widget.outerHeight(), l = d(u).width(), e = d(u).height(), i = d(u).scrollTop(), s = parseInt(this.$element.parents().filter(function() {}).first().css("z-index"), 10) + 10, c = (this.component ? this.component.parent() : this.$element).offset(), n = this.component ? this.component.outerHeight(!0) : this.$element.outerHeight(!1), o = this.component ? this.component.outerWidth(!0) : this.$element.outerWidth(!1), a = c.left, r = c.top, this.$widget.removeClass("timepicker-orient-top timepicker-orient-bottom timepicker-orient-right timepicker-orient-left"), "auto" !== this.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.orientation.x), "right" === this.orientation.x && (a -= h - o)) : (this.$widget.addClass("timepicker-orient-left"), c.left < 0 ? a -= c.left - 10 : c.left + h > l && (a = l - h - 10)), "auto" === (l = this.orientation.y) && (h = -i + c.top - t, c = i + e - (c.top + n + t), l = Math.max(h, c) === c ? "top" : "bottom"), this.$widget.addClass("timepicker-orient-" + l), "top" === l ? "body" != this.appendWidgetTo ? (r = "100%", a = "0") : r += n : "body" != this.appendWidgetTo ? (r = -t, a = "0") : r -= t + parseInt(this.$widget.css("padding-top"), 10), this.$widget.css({
                    top: r,
                    left: a,
                    zIndex: s
                }))
            ...
            showWidget: function() {
                ...
                }), this.place(), this.disableFocus && this.$element.blur(), "" === this.hour && (this.defaultTime ? this.setDefaultTime(this.defaultTime) : this.setTime("0:0:0")), "modal" === this.template && this.$widget.modal ? this.$widget.modal("show").on("hidden", d.proxy(this.hideWidget, this)) : !1 === this.isOpen && this.$widget.addClass("open"), this.isOpen = !0)
            },
            ...
            updateWidget: function() {
                var t, e, i;
                !1 !== this.$widget && (t = this.hour, e = 1 === this.minute.toString().length ? "0" + this.minute : this.minute, i = 1 === this.second.toString().length ? "0" + this.second : this.second, this.showInputs ? (this.$widget.find("input.bootstrap-timepicker-hour").val(t), this.$widget.find("input.bootstrap-timepicker-minute").val(e), this.showSeconds && this.$widget.find("input.bootstrap-timepicker-second").val(i), this.showMeridian && this.$widget.find("input.bootstrap-timepicker-meridian").val(this.meridian)) : (this.$widget.find("span.bootstrap-timepicker-hour").text(t), this.$widget.find("span.bootstrap-timepicker-minute").text(e), this.showSeconds && this.$widget.find("span.bootstrap-timepicker-second").text(i), this.showMeridian && this.$widget.find("span.bootstrap-timepicker-meridian").text(this.meridian)))
            },
            updateFromWidgetInputs: function() {
                var t;
                !1 !== this.$widget && (t = this.$widget.find("input.bootstrap-timepicker-hour").val() + ":" + this.$widget.find("input.bootstrap-timepicker-minute").val() + (this.showSeconds ? ":" + this.$widget.find("input.bootstrap-timepicker-second").val() : "") + (this.showMeridian ? this.$widget.find("input.bootstrap-timepicker-meridian").val() : ""), this.setTime(t, !0))
            },
