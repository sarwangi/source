function Header(){
    return(
		...
		<div id="top_line">
            <div class="container">
                <div class="row">
                    <div class="col-6"><i class="icon-email"></i> <strong>raj@ensoberhotels.com</strong></div>
                    <div class="col-6">
                        <ul id="top_links">
		...
		<div class="container">
			<div class="row">
				<div class="col-3">
					<div id="logo">
						<a href="index.html">
                            <img src="img/appleinn_logo.png" width="160" height="34" alt="City tours" class="logo_normal"/>
                        </a>
						<a href="index.html">
                            <img src="img/appleinn_logo.png" width="160" height="34" alt="City tours" class="logo_sticky"/>
                        </a>
					</div>
				</div>
				<nav class="col-9">
                    ...
                    <ul id="top_tools">
                        <li style={{color:'#e04f67'}}>
                            <i class="icon-phone"></i><strong>+91 95999 95888</strong>
                        </li>
                    </ul>
                </nav>
			</div>
		...
		<div id="booking_form">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-2">
                        <button class="btn_1">Book Now</button>
                    </div>
                </div>
            </div>
        </div>
